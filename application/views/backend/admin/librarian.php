    										...
    										<div class="top-header top-header-favorit">
    											<div class="top-header-thumb">
    												...
    												<div class="top-header-author">
    													...
    													<div class="author-content">
    														<a href="javascript:void(0);" class="h3 author-name"><?php echo getEduAppGTLang('librarians'); ?> <?= $branchName ?></a>
    											...
    											<div class="profile-section bg-white">
    												<div class="control-block-button">
    													<a href="javascript:void(0);" class="btn btn-control bg-purple c-btn-purple" data-toggle="modal" data-target="#crearadmin">
    																		...
    																		<div>
    																			...
    																			<div class="wid-u-info">
    																				<a href="<?php echo base_url(); ?>admin/librarian_profile/<?php echo $row['librarian_id']; ?>/" class="h6 author-name">
    																					<h5 class="mt-0 m-b-5"> <?php echo $this->crud->get_name('librarian', $row['librarian_id']); ?></h5>
    																				</a>
    																				<p class="text-muted m-b-5 font-13">
    																					...
    																					<b><i class="picons-thin-icon-thin-0535_navigation_location_drop_pin_map"></i></b> <?php echo getDetailBranch($row['branch_id'])->name; ?><br>
    																				</p>
    																			</div>
    																		</div>
    																	</div>
