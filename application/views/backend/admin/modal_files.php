                        ...
                        <table id="dataTable1" width="100%" class="table table-striped table-lightfont">
                            ...
                            ?>
                                ...
                                <tr>
                                    ...
                                    <td><a href="<?php echo base_url();?>admin/viewFile/<?php echo $row['file'];?>" target="_blank"><?php echo getEduAppGTLang('download');?></a></td>
                                    <td>
                                        <?php if($mimeType == 'application/pdf'):?>
                                            <a href="<?php echo base_url();?>admin/annotator/<?php echo $row['fhomework_file_id'];?>/<?php echo $row['homework_code'];?>/"><?php echo getEduAppGTLang('annotate');?></a>
                                            <?php if($row['edited'] == 1):?>
