                        ...
                        <div id="container">
                            ...
                            <?php if($type == 'archive' && $row['type'] != 'videos' && $row['type_video'] == ''):?>
                                    <div class="" style="text-align: center;">
                                        <div class="mt-5">
                                            <a href="<?php echo base_url();?>admin/view_lesson/download/<?php echo $row['type'];?>/<?php echo $lesson_id;?>" class="btn btn-info" style="color: #fff;">
                                            <i class="fa fa-download" style="font-size: 20px;"></i> Download <?php echo $row['type'];?></a>
                                        </div>
                                    </div>
                            <?php endif;?>
                              </div>
                                                ...
                                                <tbody>
                                                    <?php foreach($less as $ss):?>
                                                        ...
                                                        <tr style="width: 100%; padding: 5px 0px;background-color: #E6F2F5;">
                                                            <td style="text-align: left; padding:7px 10px;">
                                                                <div class="form-group">
                                                                    <a href="<?php echo base_url();?>admin/view_lesson/video/<?php echo $online_course_id;?>/<?php echo $ss['lesson_online_id'];?>" id="1" <?php if($ss['lesson_online_id'] == $lesson_id):?>style="color:red; font-size: 20px;font-weight: 500;" <?php else: ?> style="font-size: 14px;font-weight: 400;" <?php endif;?>>
                                                        ...
                                                        <tr style="width: 100%; padding: 5px 0px;background-color: #E6F2F5;">
                                                            <td style="text-align: left; padding:7px 10px;">
                                                                <div class="form-group">
                                                                    <a href="<?php echo base_url();?>admin/view_lesson/archive/<?php echo $online_course_id;?>/<?php echo $ss['lesson_online_id'];?>" id="1" <?php if($ss['lesson_online_id'] == $lesson_id):?>style="color:red; font-size: 20px;font-weight: 500;" <?php else: ?> style="font-size: 14px;font-weight: 400;" <?php endif;?>>
                                                                    <?php echo $n2++; ?>: <b><?php echo $ss['name'];?></b></a>
                                                                </div>
                                                                <div>
                                                    ...
                                                    <tr style="width: 100%; padding: 5px 0px;background-color: #E6F2F5;">
                                                        <td style="text-align: left; padding:7px 10px;">
                                                            <div class="form-group">
                                                                <a href="<?php echo base_url();?>admin/quiz_contest/<?php echo $online_course_id;?>/<?php echo $qq['quiz_id'];?>/<?php echo $lesson_id;?>" id="1" style="font-size: 14px;font-weight: 400;">
