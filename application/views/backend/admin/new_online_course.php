     ...
     <div class="os-tabs-w menu-shad">
       <div class="os-tabs-controls">
         <ul class="navs navs-tabs upper">
           <li class="navs-item">
             <a class="navs-links" href="<?php echo base_url(); ?>admin/online_courses/"><i class="picons-thin-icon-thin-0593_video_play_youtube"></i>
               <span><?php echo getEduAppGTLang('online_courses'); ?></span></a>
           </li>
           <li class="navs-item">
             <a class="navs-links active" href="<?php echo base_url(); ?>admin/new_online_course/"><i class="os-icon picons-thin-icon-thin-0086_import_file_load"></i>
         ...
         <div class="col-lg-12">
           ...
           <div class="element-wrapper">
             <div class="element-box lined-primary shadow">
               ...
               <br>
               <?php echo form_open(base_url() . 'admin/create_online_course/', array('method' => 'post', 'enctype' => 'multipart/form-data')); ?>
               <div class="row">
                 <div class="col-sm-4"><br>
                   <div class="form-group">
                     <label class="control-label" for=""><?php echo getEduAppGTLang('title'); ?></label>
                 ...
                 <div class="col-sm-4"><br>
                   ...
                   <div class="select">
                     <select name="class_id" id="class_holder" required onchange="select_section(this.value)">
                       <option value=""><?php echo getEduAppGTLang('select'); ?></option>
                     </select>
                   </div>
                 </div>
                 ...
                 <div class="col-sm-4"><br>
                   ...
                   <div class="select">
                     <select name="section_id" required onchange="get_class_subjects(this.value)" id="section_holder">
                       <option value=""><?php echo getEduAppGTLang('select'); ?></option>
                     </select>
                   </div>
                 </div>
