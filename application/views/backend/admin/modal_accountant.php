                        ...
                        <div class="form-group label-floating is-select">
                            ...
                            <div class="select">
                                <select name="branch_id" required>
                                    <option value=""><?php echo getEduAppGTLang('select_branch'); ?></option>
                                    <?php
                                    $branches = getActiveBranch();
                                    foreach ($branches as $rows) { ?>
                                        <option value="<?php echo $rows->branch_id; ?>" <?php if ($rows->branch_id == $row['branch_id']) echo "selected"; ?>><?php echo $rows->name; ?></option>
                                    <?php } ?>
                                </select>
                            </div>
                        </div>
