...
if (isSuperAdmin()) {
	...
	$branch = getBranchByAdminId($this->session->userdata('login_user_id'));
										...
										<div class="top-header top-header-favorit">
											<div class="top-header-thumb">
												...
												<div class="top-header-author">
													...
													<div class="author-content">
														<a href="javascript:void(0);" class="h3 author-name"><?php echo getEduAppGTLang('accountants'); ?><?= $branchName ?></a>
											...
											<div class="profile-section bg-white">
												<div class="control-block-button">
													<a href="javascript:void(0);" class="btn btn-control bg-purple c-btn-purple" data-toggle="modal" data-target="#new_accountant">
																		...
																		<div>
																			...
																			<div class="wid-u-info">
																				<a href="<?php echo base_url(); ?>admin/accountant_profile/<?php echo $row['accountant_id']; ?>/" class="h6 author-name">
																					<h5 class="mt-0 m-b-5"> <?php echo $this->crud->get_name('accountant', $row['accountant_id']); ?></h5>
																				</a>
																				<p class="text-muted m-b-5 font-13">
																					...
																					<b><i class="picons-thin-icon-thin-0535_navigation_location_drop_pin_map"></i></b> <?php 
																					if($row['branch_id'] == null || $row['branch_id'] == '') {
																						echo getEduAppGTLang('not_assigned_to_any_branch');
																					} else {
																						echo @getDetailBranch($row['branch_id'])->name;
																																										}
			...
			<div class="modal-body">
				...
				<div class="ui-block-content">
					...
					<div class="row">
						...
						<?php } else { ?>
							<input type="hidden" name="branch_id" value="<?php echo $branch->branch_id; ?>" hidden>
						<?php } ?>
						<div class="col col-lg-6 col-md-6 col-sm-12 col-12">
