                                ...
                                <div class="element-wrapper">
                                    <div class="element-box-tp">
                                        <h6 class="element-header">
                                            ...
                                            <div class="element-content"><a href="<?php echo base_url(); ?>admin/new_exam/<?php echo $data; ?>/" class="text-white btn btn-control btn-grey-lighter btn-success"><i class="picons-thin-icon-thin-0001_compose_write_pencil_new"></i>
                                        ...
                                        <div class="table-responsive">
                                            <table class="table table-padded">
                                                ...
                                                <tbody>
                                                    ...
                                                    ?>
                                                        <tr>
                                                            <td><button class="btn btn-<?php echo $row['status'] == 'published' ? 'success' : 'warning'; ?> btn-sm"><?php if ($row['status'] == "published") echo getEduAppGTLang('published');
                                                                                                                                                                    else if ($row['status'] == "pending") echo getEduAppGTLang('pending');
                                                                                                                                                                    else echo getEduAppGTLang('expired'); ?></button></td>
