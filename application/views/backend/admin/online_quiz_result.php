6<script src="<?php echo base_url();?>style/js/jquery.twbsPagination.js"></script>
 <style>
  .page 
  {
    display: none;
                               ...
                               $questions = $this->db->get_where('quiz_bank', array('quiz_id' => $quiz_id))->result_array();
                                ...
                                foreach ($questions as $question)
                                    ...
                                    <div style="text-align: center;">
                                        ...
                                        <h5><b><?php echo $submitted_answer_script_details['obtained_mark'].'/'.$submitted_answer_script_details['result'];?></b></h5><br>
                                    </div>
                                     <div class="back hidden-sm-down" style="margin-top:-20px;margin-bottom:10px">    
                                            <a title="back" href="<?php echo base_url();?>admin/quiz_response/<?php echo $online_course_id ?>/<?php echo $quiz_id?>/"><i class="picons-thin-icon-thin-0131_arrow_back_undo"></i></a>  
                                      </div>
                                        <?php
