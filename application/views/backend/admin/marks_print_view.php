                                ...
                                <tbody>
                                    ...
                                    foreach ($subjects as $row3):
                                        ...
                                        foreach ($marks as $row4):
                                            if (!isActiveSubject($student_id, $row3['subject_id'])) {
                                                continue;
                                            }
                                    ?>
                                            <tr>
                                                ...
                                                <td class="text-center"><?php echo $this->db->get_where('mark', array('subject_id' => $row3['subject_id'], 'exam_id' => $exam_id, 'student_id' => $student_id, 'year' => $running_year))->row()->final; ?></td>
