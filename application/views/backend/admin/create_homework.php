<style>
  ...
  <a href="<?php echo base_url();?>admin/homework/<?php echo $data;?>/"><i class="picons-thin-icon-thin-0131_arrow_back_undo"></i></a>  
  </div>  
                ...
                recorders.ondataavailable = function (e) {
                    ...
                    $( "#saveAudio").click(function() {
                        ...
                        $.ajax({
                            ...
                            url: "<?php echo base_url();?>admin/upload_audio/"+audioName,
                            data: audio_data,
                            processData: false,
                            contentType: false,
                            cache: false,
