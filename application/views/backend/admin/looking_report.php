	                ...
	                <div class="col-sm-8">
		                <div class="pipeline white lined-primary">
			                ...
			                <div class="b-t padded-v-big">
				                <?php echo getEduAppGTLang('file');?>: <a class="btn btn-rounded btn-sm btn-primary text-white" href="<?php echo base_url();?>public/uploads/report_files/<?php echo $row['file'];?>"><i class="os-icon picons-thin-icon-thin-0042_attachment"></i> <?php echo getEduAppGTLang('download');?></a>
			                </div>
			                <?php endif;?>
			                <?php if($row['status'] == 0):?><br><br>
			                <div class="b-t padded-v-big"><a class="btn btn-rounded btn-sm btn-success text-white" onClick="return confirm('<?php echo getEduAppGTLang('confirm_solved');?>')" href="<?php echo base_url();?>admin/create_report/update/<?php echo $row['code'];?>"><i class="os-icon picons-thin-icon-thin-0154_ok_successful_check"></i> <?php echo getEduAppGTLang('mark_solved');?></a></div>
			                <?php endif;?>
		                </div>
