        ...
        <div class="row">
            ...
            <div class="col-md-12">
                ...
                <div class="ui-block" data-mh="friend-groups-item" style="height:auto;">
                    ...
                    <a style="float:right; padding-right:2%;" onClick="return confirm('<?php echo getEduAppGTLang('confirm_delete');?>')"  href="<?php echo base_url();?>admin/lessons/delete_question/<?php echo $row['quiz_bank_id']?>" title="<?php echo getEduAppGTLang('delete');?>"><i class="picons-thin-icon-thin-0056_bin_trash_recycle_delete_garbage_empty"></i></a></h5>    
                    </div>
                </div>
                <?php endforeach;?>
                <?php else:?>
