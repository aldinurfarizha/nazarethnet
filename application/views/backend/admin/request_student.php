                    ...
                    <div class="tab-pane active" id="students">
                        <div class="element-wrapper">
                            <h6 class="element-header">
                                ...
                                <div class="element-content"><a href="#" data-target="#addroutine" data-toggle="modal" class="btn btn-control btn-grey-lighter btn-purple"><i class="picons-thin-icon-thin-0001_compose_write_pencil_new"></i><div class="ripple-container"></div></a></div>
                            </h6>
			                        ...
			                        <table class="table table-padded">
			                            ...
			                            ?>
                                            <tr>
                                                ...
                                                <td class="cell-with-media">
                                                    <img alt="" src="<?php echo $this->crud->get_image_url('teacher', $row['teacher_id']);?>" class="height25"><span><?php echo $this->crud->get_name('teacher', $row['teacher_id']);?></span>
                                                </td>
                                                <td><a class="badge badge-danger" href="javascript:void(0);"><?php echo $row['title'];?></a></td>
                                                <td class="bolder">
                                                    <a href="<?php echo base_url();?>admin/view_report/<?php echo $row['report_code'];?>/" class="grey"><i class="px20 picons-thin-icon-thin-0012_notebook_paper_certificate" data-toggle="tooltip" data-placement="top" data-original-title="<?php echo getEduAppGTLang('view_details');?>"></i></a>
                                                    <a  onClick="return confirm('<?php echo getEduAppGTLang('confirm_delete');?>')" href="<?php echo base_url();?>admin/request_student/delete_teacher/<?php echo $row['report_code'];?>" class="grey"><i class="px20 picons-thin-icon-thin-0057_bin_trash_recycle_delete_garbage_full" data-toggle="tooltip" data-placement="top" data-original-title="<?php echo getEduAppGTLang('delete');?>"></i></a>
                                                </td>
                                            </tr>
                                            <?php endforeach;?>
			                            </tbody>
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <div class="ui-block-title mdl-header">
                        <h6 class="title text-white"><?php echo getEduAppGTLang('add_report');?></h6>
                    </div>
                            ...
                            <div class="row">
                                ...
                                <div class="col col-lg-6 col-md-6 col-sm-12 col-12">
                                    <div class="form-group label-floating is-select">
                                        ...
                                        <div class="select">
                                            <select name="section_id" id="section_holder" onchange="get_class_students(this.value);">
                                                <option value=""><?php echo getEduAppGTLang('select');?></option>
                                            </select>
                                        </div>
                                    </div>
