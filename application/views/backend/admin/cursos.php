                                                            ...
                                                            <div class="col col-xl-8 m-auto col-lg-8 col-md-12">
                                                                <div class="os-tabs-w">
                                                                    <div class="os-tabs-controls">
                                                                        <ul class="navs navs-tabs upper" id="subjectTabs">
                                                                            <?php
                                                                            $active = 0;
                                                                    ...
                                                                    <div class="tab-pane <?php if ($active2 == 1) echo "active"; ?>" id="tab<?php echo $row['section_id']; ?>">
                                                                        <div class="row">
                                                                            <div class="col col-xl-3 col-lg-6 col-md-6 col-sm-12 col-12 margintelbot">
                                                                                <div class="min-h200 friend-item friend-groups create-group" data-mh="friend-groups-item">
                                                                                        ...
                                                                                        <div class="friend-item friend-groups">
                                                                                            <div class="friend-item-content">
                                                                                                ...
                                                                                                <div class="friend-avatar">
                                                                                                    <div class="author-thumb">
                                                                                                        <img src="<?php echo base_url(); ?>public/uploads/subject_icon/<?php echo $row2['icon']; ?>" width="120px" style="background-color:#<?php echo $row2['color']; ?>;" class="sb">
                                                                                                    </div>
                                                                                                    <div class="author-content">
                                                                                                        ...
                                                                                                        <?php if ($this->drive_model->checkSyncStatus($row2['subject_id']) == 'yet'): ?>
                                                                                                            &nbsp;&nbsp;<i data-title="<?php echo getEduAppGTLang('missing_files_to_sync'); ?>" data-toggle="tooltip" class="picons-thin-icon-thin-0061_error_warning_alert_attention"></i>
                                                                                                        <?php else: ?>
                                                                                                            &nbsp;&nbsp;<i data-title="<?php echo getEduAppGTLang('synchronized_files'); ?>" data-toggle="tooltip" class="picons-thin-icon-thin-0114_folder_cloud_sync_backup"></i>
                                                                                                        <?php endif; ?>
                                                                                                        <br><br>
    ...
    <script>
        document.addEventListener('DOMContentLoaded', function() {
            ...
            var tabLinks = subjectTabs.querySelectorAll('a');
            var tabPanes = document.querySelectorAll('.tab-pane');

            // Saat klik tab, simpan href ke localStorage
            tabLinks.forEach(function(tabLink) {
                tabLink.addEventListener('click', function() {
                    localStorage.setItem('activeSubjectTab', this.getAttribute('href'));
                });
            });
            ...
            if (activeTab) {
                var activeTabLink = subjectTabs.querySelector('a[href="' + activeTab + '"]');
                var activeTabPane = document.querySelector(activeTab);

                // Jika tab valid, reset semua dan aktifkan tab sesuai localStorage
                if (activeTabLink && activeTabPane) {
                    ...
                    // Aktifkan yang tersimpan
                    activeTabLink.classList.add('active');
                    activeTabPane.classList.add('active');
                } else {
                    // Tab di localStorage tidak ada, hapus penyimpanan
                    localStorage.removeItem('activeSubjectTab');
                    // Biarkan Bootstrap pakai default tab aktif
                }
            }
            // Jika tidak ada activeTab tersimpan, biarkan saja (Bootstrap aktifkan tab pertama)
        });
    </script>