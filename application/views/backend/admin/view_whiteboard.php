<?php
    ...
    $boards = $this->db->where(array('board_id' => $board_id))->get('boards')->result_array();
...
<head>
    ...
    <title>View Whiteboard - <?php echo $row['board_title'];?></title>
...
<body>
    <div class="px-1 position-fixed sticky-sidebar scrollbar-hidden">
        ...
        <hr>
        <button type="button" id="save-load" class="btn btn-light border p-0" data-toggle="modal" data-target="#save-load-modal">
        ...
        <a id="save-load-done" class="d-none" href="javascript:void(0);">x</a>
        <a type="button" class="btn btn-light border p-0" href="<?php echo base_url();?>admin/whiteboards/<?php echo $data;?>/">
            <em class="bi bi-arrow-90deg-left"></em>
        </a>
    </div>
    <textarea id="load-textarea" class="form-control load-item" style="display:none;" aria-label="With textarea"><?php echo $row['board_data'];?></textarea>
        ...
        <div class="modal-dialog modal-dialog-centered">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <form action="<?php echo base_url();?>admin/saveboard/" method="POST">
                        <input type="hidden" name="data" value="<?php echo $data;?>"/>
                        <div class="form-group">
                            <label><b>Whiteboard name:</b></label>
                            <input class="form-control" name="board_name" id="whiteboard_name" required="" value="<?php echo $row['board_title'];?>">    
                        </div>
                        <hr>
                        <textarea id="save-textarea" name="board" style="display:none" class="form-control save-item d-none"></textarea>
                        <button type="submit" class="btn btn-info bnt-lg">
  ...
  <div class="modal-dialog" role="document">
    ...
    <script>
        $(document).ready(function() {
            ...
            document.getElementById('save-load-done').click();
            }, 200);
        });
  </script>
</body>
