						...
						<div class="steps-w">
							...
							<div class="step-contents">
								...
								<div class="step-content" id="stepContent4">
									...
									<div class="form-buttons-w text-right">
										<button class="btn btn-rounded btn-success btn-lg" type="submit" onclick="return prepareFormData()" id="sub_form"><?php echo getEduAppGTLang('register'); ?></button>
									</div>
								</div>
							</div>
						</div>
...
<script>
	...
	function prepareFormData() {
		...
		const messages = {
			first_name: "<?= getEduAppGTLang('field') . ' ' . getEduAppGTLang('first_name') . ' ' . getEduAppGTLang('is_required') ?>",
			last_name: "<?= getEduAppGTLang('field') . ' ' . getEduAppGTLang('last_name') . ' ' . getEduAppGTLang('is_required') ?>",
			email: "<?= getEduAppGTLang('field') . ' ' . getEduAppGTLang('email') . ' ' . getEduAppGTLang('is_required') ?>",
			username: "<?= getEduAppGTLang('field') . ' ' . getEduAppGTLang('username') . ' ' . getEduAppGTLang('is_required') ?>",
			password: "<?= getEduAppGTLang('field') . ' ' . getEduAppGTLang('password') . ' ' . getEduAppGTLang('is_required') ?>",
			branch_id: "<?= getEduAppGTLang('field') . ' ' . getEduAppGTLang('branch_id') . ' ' . getEduAppGTLang('is_required') ?>",
			shifts_id: "<?= getEduAppGTLang('field') . ' ' . getEduAppGTLang('shifts_id') . ' ' . getEduAppGTLang('is_required') ?>"
		};
