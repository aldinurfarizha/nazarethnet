                                    ...
                                    <div class="col-sm-12">
                                        <div class="element-box lined-primary shadow rad10">
                                            ...
                                            <div class="row">   
                                                ...
                                                <div class="col-sm-4">
                                                    <div class="form-group label-floating is-select">
                                                        <label class="control-label"><?php echo getEduAppGTLang('enable_frontend');?></label>
                                                        <div class="select">
                                                            <select name="frontend" required="">
                                                                <option value=""><?php echo getEduAppGTLang('select');?></option>
                                                                <?php $current_calendar_language = $this->crud->getInfo('calendar'); ?>
                                                                <option value="1" <?php if ($this->crud->getInfo('frontend') == '1') echo 'selected';?>> <?php echo getEduAppGTLang('enabled');?> </option>
                                                                <option value="2" <?php if ($this->crud->getInfo('frontend') == '2') echo 'selected';?>> <?php echo getEduAppGTLang('disabled');?> </option>
                                                            </select>
                                                        </div>
                                                    </div>
                                                </div>
                                        ...
                                        <div class="element-box lined-warning shadow" style="border-radius:10px;">
                                            <?php echo form_open(base_url() . 'admin/system_settings/zoom');?>
                                                <h4 class="form-header"><?php echo getEduAppGTLang('zoom_api');?></h4><br>  
                                                <div class="row">
                                                    <div class="col-sm-6">
                                                        <div class="form-group label-floating">
                                                            <label class="control-label">Zoom API Key</label>
                                                            <input class="form-control" value="<?php echo $this->db->get_where('settings', array('type' => 'zoom_key'))->row()->description;?>" type="text" name="zoom_key" required="">
                                                            <span class="material-input"></span>
                                                        </div>
                                                    </div>
                                                    <div class="col-sm-6">
                                                        <div class="form-group label-floating">
                                                            <label class="control-label">Zoom API Secret</label>
                                                            <input class="form-control" value="<?php echo $this->db->get_where('settings', array('type' => 'zoom_secret'))->row()->description;?>" type="text" name="zoom_secret" required="">
                                                            <span class="material-input"></span>
                                                        </div>
                                                    </div>
                                                    <div class="col-sm-12">
