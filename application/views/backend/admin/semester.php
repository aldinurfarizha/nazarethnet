                            ...
                            <div class="element-box-tp">
                                <div class="table-responsive">
                                    <table class="table table-padded">
                                        ...
                                        <tbody>
                                            <?php $n = 1;
                                            $semesters = $this->db->get_where('exam', array('class_id' => $class_id, 'section_id' => $section_id, 'subject_id' => $subject_id))->result_array();
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-sm-6">
                                                    <div class="form-group label-floating is-select">
                                                        <label class="control-label"><?php echo getEduAppGTLang('class'); ?></label>
                                                        <div class="select">
                                                            <select name="class_id" required="" id="class_holder2" onchange="getSec(this.value)">
                                                                <option value=""><?php echo getEduAppGTLang('select'); ?></option>
                                                                <?php
