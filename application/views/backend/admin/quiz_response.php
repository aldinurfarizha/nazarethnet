...
<div class="content-w">
  ...
  <div class="col-sm-12">
    ...
    <div class="back hidden-sm-down" style="margin-top:-20px;margin-bottom:10px">		
        <a title="back" href="<?php echo base_url();?>admin/lessons/<?php echo $online_course_id?>"><i class="picons-thin-icon-thin-0131_arrow_back_undo"></i></a>	
	</div>
            ...
            <tbody>
              <?php foreach ($students_array as $row):?>
                    <tr>
                      ...
                      <td><?php  if ($query->num_rows() > 0){?><a href="<?php echo base_url();?>admin/online_quiz_result/<?php echo $quiz_id;?>/<?php echo $online_course_id;?>/<?php echo $row['student_id'];?>/" class="btn btn-success btn-sm btn-rounded"><?php echo getEduAppGTLang('view_results');?></a><?php } else echo getEduAppGTLang('no_actions');?></td>
                    </tr>
            <?php endforeach; ?>
                </tbody>
            </table>
