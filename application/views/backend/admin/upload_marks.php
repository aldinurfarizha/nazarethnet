                                                ...
                                                <tbody>
                                                    <tr class="bg-primary text-white" style="padding:0px">
                                                        <td class="text-center col-sticky nums bg-white" width="85px">
                                                            ...
                                                            <a style="display:inline-block;margin-bottom:2px" href="<?php echo base_url(); ?>admin/upload_marks/<?php echo $data; ?>/<?php echo $exam_id; ?>/<?php echo $studentsOrder; ?>/" class="btn btn-primary btn-sm"><?php if ($order == 1) echo 'A-Z'; elseif ($order == 2) echo 'Z-A'; ?></a>
                                                        </td>
                                                        ...
                                                        <td class="text-center" style="padding:5px">
                                                            ...
                                                            <a class="text-white" href="<?php echo base_url().'admin/manage_marks/delete_capacity/'.$data.'/'.$exam_id.'/'.$order.'/'.$cap['mark_activity_id'].'/';?>" onclick="return confirm('<?php echo getEduAppGTLang('confirm_delete');?>');"><svg class="align-sub" xmlns="http://www.w3.org/2000/svg" width="15" height="15" viewBox="0 0 24 24"><path fill="none" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M14 11v6m-4-6v6M6 7v12a2 2 0 0 0 2 2h8a2 2 0 0 0 2-2V7M4 7h16M7 7l2-4h6l2 4"/></svg></a>
                                                        </td>
                                                        <?php endforeach; ?>
                                                        <td class="text-center" style="padding:5px">
                                                            Comentario
