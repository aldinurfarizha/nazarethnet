    ...
    <div class="os-tabs-w menu-shad">
      <div class="os-tabs-controls">
        <ul class="navs navs-tabs upper">
          ...
          <li class="navs-item">
            <a class="navs-links active" href="<?php echo base_url();?>admin/whiteboards/<?php echo $data;?>/"><i class="os-icon picons-thin-icon-thin-0191_window_application_cursor"></i><span><?php echo getEduAppGTLang('whiteboards');?></span></a>
          </li>
          <li class="navs-item">
          ...
          <main class="col col-xl-12 order-xl-2 col-lg-12 order-lg-1 col-md-12 col-sm-12 col-12">
            <div id="newsfeed-items-grid">                
                <div class="element-wrapper">
                    ...
                    <div style="margin-top:auto;float:right;"><a href="<?php echo base_url();?>admin/new_whiteboard/<?php echo $data;?>/" class="text-white btn btn-control btn-grey-lighter btn-success"><i class="picons-thin-icon-thin-0001_compose_write_pencil_new"></i><div class="ripple-container"></div></a></div>
                    </h6>
                    ...
                    <table class="table table-padded">
                        <thead>
                          ...
                          <tr>
                            ...
                            <td class="bolder">
                                <a class="btn btn-warning btn-sm" href="<?php echo base_url();?>admin/view_whiteboard/<?php echo $row3['board_id'];?>/<?php echo $data;?>"><?php echo getEduAppGTLang('view_board');?></a>
                                <a class="btn btn-danger btn-sm" onclick="return confirm('<?php echo getEduAppGTLang('are_you_sure');?>');" href="<?php echo base_url();?>admin/deleteBoard/<?php echo $row3['board_id'];?>/<?php echo $data;?>"><?php echo getEduAppGTLang('delete_board');?></a>
                            </td>
                          </tr>
                        <?php endforeach;?>
                      </tbody>
