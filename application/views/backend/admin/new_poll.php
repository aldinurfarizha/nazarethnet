	  						    ...
	  						    <div class="element-box lined-primary shadow">
							        <?php echo form_open(base_url() . 'admin/polls/create_wall/' , array('enctype' => 'multipart/form-data'));?>
		  					            ...
		  					            <div class="form-group">
			  					            <div class="col-sm-12">
			  						            <label class="col-form-label logoutleft"><?php echo getEduAppGTLang('question');?></label>
							            ...
							            <div id="bulk_add_form">
          					            ...
          					            <center><a href="javascript:void(0);" class="btn btn-rounded btn-success btn-sm" onClick="entry()">+ <?php echo getEduAppGTLang('more_options');?></a></center>							<br>
							            <div class="form-group">
				            	            <div class="col-sm-12">
