                       ...
                       foreach ($questions as $n) {
                        ...
                        <div class="conty">
                          ...
                          <div class="col-sm-12 text-center">
                            <a href="<?php echo base_url();?>admin/online_courses/" ><button class="btn btn-rounded btn-success text-center" id="subbutton"><?php echo getEduAppGTLang('finish_exam');?></button></a>
                          </div>
                          <?php else:?>
                          <br><br>
                            <div class="col-sm-12 text-center">
                                ...
                                <div class="card" style="margin:0px 0px;">
                                            ...
                                            <table style="width: 100%;">
                                                <tbody>
                                                    ...
                                                    <tr style="width: 100%; padding: 5px 0px;background-color: #E6F2F5;">
                                                        <td style="text-align: left; padding:7px 10px;">
                                                            <div class="form-group">
                                                                <a href="<?php echo base_url();?>admin/quiz_contest/<?php echo $online_course_id;?>/<?php echo $qq['quiz_id'];?>" id="1" <?php if($qq['quiz_id'] == $quiz_id):?>style="color:red; font-size: 20px;font-weight: 500;" <?php else: ?> style="font-size: 14px;font-weight: 400;" <?php endif;?>>
                                    ...
                                    <div class="card" style="margin:0px 0px;">
                                        <div class="card-header course_card">
                                            ...
                                            <?php echo getEduAppGTLang('create_sectiopns_here');?>
                                            </h5></a>
                                        </div>
                                    </div>
                                    <?php endif;?>
