                                        ...
                                        <div class="friend-item-content">
                                            <div class="friend-avatar">
                                                <div class="author-thumb">
                                                    <img src="<?php echo base_url();?>public/uploads/icons/backup.svg" width="110px" class="bg-white padd15 no-border">
                                                </div>
                                    ...
                                    <div class="friend-item friend-groups">
                                        <div class="friend-item-content">
                              	            <?php echo form_open(base_url() . 'admin/database/restore', array('enctype' => 'multipart/form-data'));?>
                                                <div class="friend-avatar">
                                                    <div class="author-thumb">
                                                        <img src="<?php echo base_url();?>public/uploads/icons/restore.svg" width="110px" class="no-border padd15 bg-white">
                                                    </div>
                                                    <div class="author-content">
                                                ...
                                                <div class="control-block-button">
                                                    <center><input id="upload3" type="file" name="file_name" class="control-upload"></center>
                                                </div>
                                                <div class="control-block-button">
