                                    ...
                                    <div class="os-tabs-w">
                                        <div class="os-tabs-controls">
                                            <ul class="navs navs-tabs upper">
                                                ...
                                                <li class="navs-item">
                                                    <a class="navs-links active" href="<?php echo base_url();?>admin/recaptcha/"><?php echo getEduAppGTLang('recaptcha');?></a>
                                                </li> 
                                                <li class="navs-item">
                                        ...
                                        <div class="element-box lined-success shadow rad10">
                                            <?php echo form_open(base_url() . 'admin/frontend/recaptcha', array('enctype' => 'multipart/form-data'));?>
                                                <h4 class="form-header"><?php echo getEduAppGTLang('recaptcha_settings');?></h4><br>
                                                    <div class="row">
                                                        <div class="col-sm-6">
                                                            <div class="form-group">
                                                                <label class="control-label"><?php echo getEduAppGTLang('site_key');?></label>
                                                                <input class="form-control" value="<?php echo $this->crud->getFront('site_key');?>" type="text" name="site_key" required="">
                                                                <span class="material-input"></span>
                                                            </div>
                                                        </div>
                                                        <div class="col-sm-6">
                                                            <div class="form-group">
                                                                <label class="control-label"><?php echo getEduAppGTLang('secret_key');?></label>
                                                                <input class="form-control" value="<?php echo $this->crud->getFront('secret_key');?>" type="text" name="secret_key" required="">
                                                                <span class="material-input"></span>
                                                            </div>
                                                        </div>
                                                        <div class="col-sm-12">
