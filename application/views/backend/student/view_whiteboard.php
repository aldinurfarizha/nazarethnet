...
<body>
    <div class="px-1 position-fixed sticky-sidebar scrollbar-hidden">
        ...
        <a type="button" class="btn btn-light border p-0" href="<?php echo base_url();?>student/whiteboards/<?php echo $data;?>/">
        ...
        <div class="modal-dialog modal-dialog-centered">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title save-item" id="save-lable">Download</h5>
