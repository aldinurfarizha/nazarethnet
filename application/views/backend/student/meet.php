            ...
            <div class="cursos cta-with-media" style="background: #<?php echo $rows['color'];?>;">
                <div class="cta-content">
                    <div class="user-avatar">
                        <img alt="" src="<?php echo base_url();?>public/uploads/subject_icon/<?php echo $rows['icon'];?>" class="width-60">
                    </div>
                                                ...
                                                <tbody>
                                                  ...
                                                  ?>  
                                                    <tr>
                                                        ...
                                                        <td class=" bolder">
                                                            <a target="_blank" href="<?php echo base_url();?>student/liveClass/<?php echo base64_encode($row['zoom_id']);?>" style="color:gray;"><span><i style="color:gray;" class="picons-thin-icon-thin-0139_window_new_extern_full_screen_maximize"></i></span></a>
                                                        </td>
                                                    </tr>
                                                    <?php endforeach;?>
                                                </tbody>
