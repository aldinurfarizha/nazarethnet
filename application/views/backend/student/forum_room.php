                                        ...
                                        <tr>
                                            ...
                                            <td class="posts">
                                                ...
                                                <?php if($row['file_name'] != ""):?>
                                                    <?php echo getEduAppGTLang('file');?>: <a class="btn btn-rounded btn-sm btn-primary" href="<?php echo base_url().'student/viewFile/'.$row['file_name']; ?>" class="text-white"><i class="os-icon       picons-thin-icon-thin-0042_attachment"></i> <?php echo $row['file_name'];?></a>
                                                <?php endif;?>
                                            </td>
                                        </tr> 
                                        <?php
                            ...
                            <div class="element-box shadow lined-success">
                                <div class="row f-line">
                                    <div class="col-sm-12">
                                        ...
                                        <div class="form-group is-empty full-width"><textarea class="form-control" placeholder="<?php echo getEduAppGTLang('write_message');?>..." id="message" name="message" required="" rows="5"></textarea><span class="material-input"></span></div>
