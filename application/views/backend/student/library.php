            ...
            <div class="content-box">
                    ...
                    <div class="os-tabs-controls">
                        <ul class="navs navs-tabs upper nvs">
                            <li class="navs-item show-inline2">
                                <a class="navs-link active text-black" data-toggle="tab" href="#all"><?php echo getEduAppGTLang('library');?></a>
                            </li>
                            <li class="navs-item">
                                <a class="navs-link text-black" data-toggle="tab" href="#request"><?php echo getEduAppGTLang('book_request');?></a>
                            </li>
                        </ul>
                    </div>
                </div>
                <div class="tab-content">
                    ...
                    <div class="tab-pane" id="request">
                        <div class="element-wrapper">
                            <div class="element-content"><a href="javascript:void(0);" data-target="#new_request" data-toggle="modal" class="text-white btn btn-control btn-grey-lighter btn-success"><i class="picons-thin-icon-thin-0001_compose_write_pencil_new"></i><div class="ripple-container"></div></a></div>
                            <div class="element-box-tp">
                                <div class="table-responsive">
                                    <table class="table table-padded">
                                        <thead>
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <div class="ui-block-title mdl-header">
                        <h6 class="title text-white"><?php echo getEduAppGTLang('new_request');?></h6>
                    </div>
