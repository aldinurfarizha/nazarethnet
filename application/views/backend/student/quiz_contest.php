                ...
                <div class="row" id="container">
                    <div class="col-lg-9 course_col order-md-1">
                       ...
                       foreach ($questions as $n) {
                          ...
                          ?> 
                        <form class="" action="<?php echo base_url();?>student/submit_quiz/<?php echo $quiz_id;?>/" method="post" enctype="multipart/form-data" id="answer_script">
                        <div class="conty">
                            <div class="content-i">
                              <div class="content-box">
                                        ...
                                        ?>
                                          <div class="col-sm-12">
                                            <label class="containers"><?php echo $options[$i];?>
                                                <input type="checkbox" name="<?php echo $question['quiz_bank_id'].'[]'; ?>" value="<?php echo $i + 1;?>">
                        ...
                        <div class="col-sm-12 text-center">
                            <button class="btn btn-rounded btn-success text-center" id="subbutton"><?php echo getEduAppGTLang('finish_quiz');?></button>
                        </div>
                        </form>
                        <br> <br>
                        <div class="card">
                                        ...
                                        <div class="card-body" style="padding:0px;">
                                            <table style="width: 100%;">
                                                <tbody>
                                                    ...
                                                    <tr style="width: 100%; padding: 5px 0px;background-color: #E6F2F5;">
                                                        <td style="text-align: left; padding:7px 10px;">
                                                            <div class="form-group"><?php $vv  = $this->db->get_where('progress_course', array('online_course_id' => $online_course_id, 'student_id' => $this->session->userdata('login_user_id'), 'quiz_id' => $qq['quiz_id']))->num_rows(); ?>
                                                                <a href="<?php echo base_url();?>student/quiz_contest/<?php echo $online_course_id;?>/<?php echo $qq['quiz_id'];?>" id="1" <?php if($vv > 0 ):?>style="color:#90be2e; font-size: 20px;font-weight: 500;" <?php else: ?> style="font-size: 14px;font-weight: 400;" <?php endif;?>>
