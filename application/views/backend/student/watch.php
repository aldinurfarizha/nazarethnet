               ...
               <div class="row">
                    ...
                    <?php if($row['provider'] == 'local'):?>
                        ...
                        <?php $tt = explode(".", $row['url_video']);?>
                            <video style="width:100%;" controls crossorigin playsinline poster="<?php echo base_url();?>public/uploads/online_course_image/<?php echo $row['thumbnail']; ?>">
                                    <source src="<?php echo base_url();?>public/uploads/online_course_video/<?php echo $row['url_video'];?>" type="video/<?php echo $tt[1];?>" size="720">
                                    <!-- Caption files -->
                               ...
                               <?php 
                                ...
                                <div class="card" style="margin:0px 0px;">
                                                    ...
                                                    <tr style="width: 100%; padding: 5px 0px;background-color: #E6F2F5;">
                                                        <td style="text-align: left; padding:7px 10px;">
                                                            <div class="form-group"><?php $vv  = $this->db->get_where('progress_course', array('online_course_id' => $online_course_id, 'student_id' => $this->session->userdata('login_user_id'), 'quiz_id' => $qq['quiz_id']))->num_rows(); ?>
                                                                <a href="<?php echo base_url();?>student/quiz_contest/<?php echo $online_course_id;?>/<?php echo $qq['quiz_id'];?>/<?php echo $lesson_online_id;?>" id="1" <?php if($vv > 0 ):?>style="color:#90be2e; font-size: 20px;font-weight: 500;" <?php else: ?> style="font-size: 14px;font-weight: 400;" <?php endif;?>>
                                    ...
                                    <div class="card" style="margin:0px 0px;">
                                        <div class="card-header course_card">
                                            <h3>
                                                <?php echo getEduAppGTLang('no_content');?>
                                            </h3>
                                        </div>
                                    </div>
                                    <?php endif;?>
