...
<html lang="en">
    <head>
        <title>Completed | <?php echo $system_title;?></title>
    ...
    <body style="background:#fff!important">
        <div class="container" style="margin-top:20%">
            <h3 class="text-center">Daily attendance completed</h3>
            <center><img src="<?php echo base_url();?>public/uploads/success.gif" style="width:150px"></center>
            <br><br>
            <center><a class="btn btn-info" href="<?php echo base_url();?>">Back to home</a></center>
        </div>
        <script>
            function close()
            {
