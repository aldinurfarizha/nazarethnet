...
$dataSC = getStudentClassAndSectionById($this->session->userdata('login_user_id'));
?>
                          ...
                          <table id="table2" style="width: 100%; min-height: 55vh;">
                            <tbody>
                              ...
                              <tr>
                                ...
                                <td class="redips-mark lunch no_schedules" <?php if ($sundays == 1) : ?>colspan="7" <?php else : ?>colspan="5" <?php endif; ?>>
                                  <h6><?php echo $break_1; ?></h6>
                                </td>
                              </tr>
                              <?php
                              $despues = $hrs_fin + 2;
