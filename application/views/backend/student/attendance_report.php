                                            ...
                                            <div class="element-box-tp">
                                                ...
                                                <div class="table-responsive">
                                                    <table class="table table-sm table-lightborder">
                                                        ...
                                                        <tbody>
                                                            <tr>
                                                                <td><img alt="" src="<?php echo $this->crud->get_image_url($this->session->userdata('login_type'), $this->session->userdata('login_user_id')); ?>" width="20px" class="tbl-st"> <?php echo $this->crud->get_name('student', $this->session->userdata('login_user_id')); ?> </td>
                                                                <?php
                                                                $status = 0;
                                                                for ($i = 1; $i <= $days; $i++) {
