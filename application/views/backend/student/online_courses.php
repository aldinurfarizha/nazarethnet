        ...
        <div class="top-header-thumb">
          ...
          <div class="top-header-author">
            ...
            <div class="author-content">
              <a href="javascript:void(0);" class="h3 author-name"><?php echo getEduAppGTLang('my_online_courses'); ?></a>
              <br>
              <?php
              $studentClassGroup = getStudentGroupClassById($this->session->userdata('login_user_id'));
              foreach ($studentClassGroup as $scg) {
                echo '<small>' . $scg->class_name . '|</small>';
              }
              ?>
            </div>
          </div>
    ...
    <div class="content-box">
      <div class="row mt-3">
        ...
        foreach ($studentData as $datax) {
          ...
          $courses = $this->db->get_where('online_course', array('class_id' => $datax->class_id, 'section_id' => $datax->section_id, 'status' => 1))->result_array();
                  ...
                  <div class="friend-item-content">
                    ...
                    <div class="friend-avatar">
                      ...
                      <div class="author-content">
                        ...
                        <img src="<?php echo $this->crud->get_image_url($row['user'], $row['user_id']); ?>" style="border-radius:50%; width:30px;"><span> <?php echo $this->crud->get_name($row['user'], $row['user_id']); ?></span>
                      </div><br>
                    ...
                    <div class="skills-item">
                      <div class="skills-item-info">
                        <span class="skills-item-count">
                          ...
                          <span class="units"><?php if ($cont > 1) : echo number_format((($cont - 1) * 100) / $row['lesson']);
                                              else : echo '0';
                                              endif; ?>%</span>
                        </span>
                      </div>
                      ...
                      <div class="skills-item-meter">
                        <span class="skills-item-meter-active bg-primary skills-animate" style="width: <?php echo ($row['lesson'] > 0 ? number_format((($cont - 1) * 100) / $row['lesson']) : 0); ?>%; opacity: 1;"></span>
                      </div>
                    </div>
                  </ul>
                </div>
