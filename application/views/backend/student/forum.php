    		                                    ...
    		                                    ?>
                                                    <tr>
					                                    ...
					                                    <td class="row-actions">
						                                    <a class="btn btn-rounded btn-sm btn-primary text-white" href="<?php echo base_url();?>student/forumroom/<?php echo $row['post_code']; ?>"><i class="picons-thin-icon-thin-0043_eye_visibility_show_visible"></i> <?php echo getEduAppGTLang('view_forum');?></a>
					                                    </td>
                                                    </tr>
                                                <?php endforeach;?>
                                                </tbody>
