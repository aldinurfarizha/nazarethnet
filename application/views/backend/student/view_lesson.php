                        ...
                        <div id="container">
                            <div class="post-thumb">
                                <?php if($type == 'video' && $row['type'] == 'videos' && $row['type_video'] == 'local'):  $tt = explode(".", $row['name_video']);?>
                                        <video style="width:100%;" controls crossorigin playsinline poster="<?php echo base_url();?>public/uploads/online_course_image/<?php echo $row['image_video'];?>">
                                                <source src="<?php echo base_url();?>public/uploads/online_course_video/<?php echo $row['name_video'];?>" type="video/<?php echo $tt[1];?>" size="720">
                                                <!-- Caption files -->
                                ...
                                <?php if($type == 'archive' && $row['type'] != 'videos' && $row['type_video'] == ''):?>
                                        <div class="" style="text-align: center;">
                                            <div class="mt-5">
                                                <a href="<?php echo base_url();?>student/view_lesson/download/<?php echo $row['type'];?>/<?php echo $lesson_id;?>" class="btn btn-info" style="color: #fff;">
                            ...
                            <div class="col-12">
                               <?php 
                                ...
                                <div class="card" style="margin:0px 0px;">
                                        ...
                                        <div class="card-body" style="padding:0px;">
                                            <table style="width: 100%;">
                                                <tbody>
                                                    <?php foreach($less as $ss):?>
                                                        ...
                                                        <tr style="width: 100%; padding: 5px 0px;background-color: #E6F2F5;">
                                                            <td style="text-align: left; padding:7px 10px;">
                                                                <div class="form-group"> <?php $vv  = $this->db->get_where('progress_course', array('online_course_id' => $online_course_id, 'student_id' => $this->session->userdata('login_user_id'), 'lesson_id' => $ss['lesson_online_id']))->num_rows(); ?>
                                                    ...
                                                    <tr style="width: 100%; padding: 5px 0px;background-color: #E6F2F5;">
                                                        <td style="text-align: left; padding:7px 10px;">
                                                            <div class="form-group"><?php $ws  = $this->db->get_where('progress_course', array('online_course_id' => $online_course_id, 'student_id' => $this->session->userdata('login_user_id'), 'quiz_id' => $qq['quiz_id']))->num_rows(); ?>
                                                                <a href="<?php echo base_url();?>student/quiz_contest/<?php echo $online_course_id;?>/<?php echo $qq['quiz_id'];?>/<?php echo $lesson_id;?>" id="1" <?php if($ws > 0 ):?>style="color:#90be2e; font-size: 20px;font-weight: 500;" <?php else: ?> style="font-size: 14px;font-weight: 400;" <?php endif;?>>
                                    ...
                                    <div class="card" style="margin:0px 0px;">
                                        <div class="card-header course_card">
                                            <a href="<?php echo base_url();?>student/lessons/<?php echo $online_course_id;?>" ><h5 class="text-center">
                                          <?php echo getEduAppGTLang('no_lessons');?>  
                                            </h5></a>
                                        </div>
                                    </div>
                                    <?php endif;?>
