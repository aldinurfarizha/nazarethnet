                                            ...
                                            <table class="table table-padded">
                                                ...
                                                <tbody>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td class="bolder">
                                                            <a class="grey" href="<?php echo base_url();?>student/homeworkroom/<?php echo $row['homework_code']; ?>" data-toggle="tooltip" data-placement="top" data-original-title="<?php echo getEduAppGTLang('view_homework');?>"><i class="picons-thin-icon-thin-0043_eye_visibility_show_visible"></i></a>
                                                        </td>
                                                    </tr>
                                                    <?php endforeach;?>
                                                </tbody>
