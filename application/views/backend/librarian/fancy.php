...
<?php $fc_info = base64_decode(@$data);
$fc_ex = explode('-', $fc_info); ?>
<?php $userDetail = $this->db->get_where('librarian', array('librarian_id' => $this->session->userdata('login_user_id')))->row(); ?>
            ...
            <div class="author-page author vcard inline-items more">
                ...
                <a href="javascript:void(0);" class="author-name fn">
                    <div class="author-title">
                        <?php echo $this->crud->get_name('librarian', $this->session->userdata('login_user_id')); ?> <svg class="olymp-dropdown-arrow-icon">
