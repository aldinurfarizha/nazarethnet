				            ...
				            <div class="friend-item friend-groups">
    					        <div class="friend-item-content">
						            <div class="friend-avatar">
							            ...
							            <h1 class="text-bold"><?php echo $this->db->get_where('book', array('branch_id' => $librarian_info->branch_id))->num_rows();?></h1>
				            ...
				            <div class="friend-item friend-groups">
					            <div class="friend-item-content">
						            <div class="friend-avatar">
							            ...
							            <h1 class="text-bold"><?php $t = 0; $total_copies = $this->db->get_where('book', array('branch_id' => $librarian_info->branch_id))->result_array(); foreach($total_copies as $r) {$t += $r['total_copies'];} echo $t;?></h1>
							            <div class="author-content">
				            ...
				            <div class="friend-item friend-groups">
					            <div class="friend-item-content">
						            <div class="friend-avatar">
							            ...
							            <h1 class="text-bold"><?php $to = 0; $copies =  $this->db->get_where('book', array('branch_id' => $librarian_info->branch_id))->result_array(); foreach($copies as $row){$to += $row['issued_copies'];} echo $to;?></h1>
							            <div class="author-content">
                    ...
                    <div class="tab-pane active" id="students">
                        <div class="element-wrapper">
                            <h6 class="element-header">
                                ...
                                <div class="element-content"><a href="javascript:void(0);" data-target="#addroutine" data-toggle="modal" class="btn btn-control btn-grey-lighter btn-success"><i class="picons-thin-icon-thin-0001_compose_write_pencil_new"></i><div class="ripple-container"></div></a></div>
                            </h6>
                            <div class="element-box-tp">
                                <div class="table-responsive">
                                    <table class="table table-padded">
                                        ...
                                        <tbody>
                                        <?php $count = 1; 
				                            $book = $this->db->get_where('book', array('branch_id' => $librarian_info->branch_id))->result_array();
			                                foreach($book as $row):
                                            ?>
			                                <tr>
                                				...
                                				<?php if($row['type'] == 'virtual'):?>
                                					<a class="btn btn-rounded btn-sm btn-purple text-white"><?php echo getEduAppGTLang('virtual');?></a>
                                				<?php else:?>
                                					<a class="btn btn-rounded btn-sm btn-info text-white"><?php echo getEduAppGTLang('normal');?></a>
                                				<?php endif;?>
                                				</td>
                                				...
                                				<td><a class="btn btn-rounded btn-sm btn-success text-white"><?php echo $this->db->get_where('settings', array('type' => 'currency'))->row()->description;?><?php echo $row['price'];?></a></td>
                                				<td class="grey">
                                				<?php if($row['type'] == 'virtual' && $row['file_name'] != ""):?>
                                					<a class="btn btn-rounded btn-sm btn-primary text-white" href="<?php echo base_url();?>public/uploads/library/<?php echo $row['file_name'];?>"><i class="picons-thin-icon-thin-0042_attachment"></i> <?php echo getEduAppGTLang('download');?></a>
                                				<?php else:?>
                                					<?php echo getEduAppGTLang('no_downloaded');?>
                                				<?php endif;?>
				                                </td>
				                                <td class="row-actions">
					                                <a class="grey" href="<?php echo base_url();?>librarian/update_book/<?php echo $row['book_id'];?>"><i class="picons-thin-icon-thin-0001_compose_write_pencil_new"></i></a>
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <div class="ui-block-title mdl-header">
                        <h6 class="title text-white"><?php echo getEduAppGTLang('add_book');?></h6>
                    </div>
                    <div class="ui-block-content">
                        <?php echo form_open(base_url() . 'librarian/library/create' , array('enctype' => 'multipart/form-data'));?>
                            <div class="row">
                                <input type="hidden" name="branch_id" value="<?php echo $librarian_info->branch_id; ?>">
                                    ...
                                    <div class="form-group label-floating is-select">
                                        ...
                                        <div class="select">
                                            <select name="class_id" required>
                                                ...
                                                <?php $cl = $this->db->get_where('class', array('branch_id' => $librarian_info->branch_id))->result_array();
                                                    foreach($cl as $row):
                  	                            ?>
