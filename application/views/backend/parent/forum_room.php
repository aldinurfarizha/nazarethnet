                                        ...
                                        <tr>
                                            ...
                                            <td class="posts">
                                                ...
                                                <?php if($row['file_name'] != ""):?>
                                                    <?php echo getEduAppGTLang('file');?>: <a class="btn btn-rounded btn-sm btn-primary text-white" href="<?php echo base_url();?>parents/viewFile/<?php echo $row['file_name'];?>"><i class="os-icon       picons-thin-icon-thin-0042_attachment"></i> <?php echo $row['file_name'];?></a>
                                                <?php endif;?>
                                            </td>
                                        </tr> 
                                        <?php
