        ...
        <div class="conty">
            ...
            <div class="cursos cta-with-media" style="background: #<?php echo $rows['color']; ?>;">
                <div class="cta-content">
                    ...
                    <small class="subject-desc"><?php echo $this->crud->get_name('student', $explode_data[3]); ?> | <?php echo $this->db->get_where('class', array('class_id' => $explode_data[0]))->row()->name; ?> "<?php echo $this->db->get_where('section', array('section_id' => $explode_data[1]))->row()->name; ?>"</small>
                </div>
            </div>
            <div class="os-tabs-w menu-shad">
                <div class="os-tabs-controls">
                    <ul class="navs navs-tabs upper">
                        ...
                        <li class="navs-item">
                            <a class="navs-links" href="<?php echo base_url(); ?>parents/gamification/<?php echo $data; ?>/"><i class="os-icon picons-thin-icon-thin-0659_medal_first_place_winner_award_prize_achievement"></i><span><?php echo getEduAppGTLang('gamification'); ?></span></a>
                        </li>
                    </ul>
                </div>
            </div>
                                    ...
                                    <div id='cssmenu'>
                                        <ul>
                                            ...
                                            foreach ($examss as $exam):
                                                $var++;
                                            ?>
                                                <li class='<?php if ($exam['exam_id'] == $exam_id) echo "act"; ?>'><a href="<?php echo base_url(); ?>parents/subject_marks/<?php echo $data . '/' . $exam['exam_id']; ?>/"><i class="os-icon picons-thin-icon-thin-0023_calendar_month_day_planner_events"></i><?php echo $exam['name']; ?>
                                    ...
                                    <div class="element-box-tp">
                                        <div class="table-responsive">
                                            <table class="table table-lightborder">
                                                ...
                                                <tbody>
                                                    <?php
                                                    $classID = $this->db->get_where('enroll', array('student_id' => $student_id, 'year' => $running_year))->row()->class_id;
                                                    $sectionID = $this->db->get_where('enroll', array('student_id' => $student_id, 'year' => $running_year))->row()->section_id;
                                                    ...
                                                    ?>
                                                        <tr>
                                                            ...
                                                            <td class="text-center">
                                                                <?php
                                                                $nota_cap = $this->db->order_by('nota_capacidad_id', 'ASC')->get_where('nota_capacidad', array('mark_activity_id' => $cap['mark_activity_id'], 'student_id' => $student_id))->row();
                                                                ?>
                                                ...
                                                <tfoot>
                                                    <tr>
                                                        <td><b>Total</b></td>
                                                        <td class="text-center"><b><?php echo $this->db->get_where('mark', array('subject_id' => $rows['subject_id'], 'exam_id' =>  $exam_id, 'student_id' => $student_id, 'year' => $running_year))->row()->mark_obtained; ?></b></td>
                                                    </tr>
                                                    <?php if ($is_final) { ?>
                                                        <tr>
                                                            <td><b>EVALUACIONES FINALES</b></td>
                                                            <td class="text-center"><b><?= getFinalMark($student_id, $rows['subject_id'], $exam_id, $running_year) ?></b></td>
                                                        </tr>
                                                    <?php } else { ?>
                                                        <tr>
                                                            <td><b>Prom</b></td>
                                                            <td class="text-center"><b><?php echo $this->db->get_where('mark', array('subject_id' => $rows['subject_id'], 'exam_id' =>  $exam_id, 'student_id' => $student_id, 'year' => $running_year))->row()->final; ?></b></td>
                                                        </tr>
                                                    <?php } ?>
                                        ...
                                        <a class="btn btn-sm btn-success text-white mgleft" href="<?php echo base_url(); ?>parents/marks/"><?php echo getEduAppGTLang('view_all_marks'); ?></a><br><br>
                                    </div>
                                </div>
                            </div>
                        </main>
