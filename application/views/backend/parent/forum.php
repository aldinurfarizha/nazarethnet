                                            ...
                                            <table class="table table-padded">
    		                                    ...
    		                                    ?>
                                                    <tr>
					                                    ...
					                                    <td><a class="btn nc btn-rounded btn-sm btn-success text-white"><?php echo $row['timestamp'];?></a></td>
					                                    <td class="row-actions">
						                                    <a class="btn btn-rounded btn-sm btn-primary text-white" href="<?php echo base_url();?>parents/forumroom/<?php echo $row['post_code']; ?>/<?php echo $ex[3];?>/"><i class="picons-thin-icon-thin-0043_eye_visibility_show_visible"></i> <?php echo getEduAppGTLang('view_forum');?></a>
					                                    </td>
                                                    </tr>
                                                <?php endforeach;?>
                                                </tbody>
