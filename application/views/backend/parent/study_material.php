<?php 
    ...
    foreach($sub as $rows):
        $finish=0;
        if(isStudentFinishSubject($ex[3], $ex[2])){
            $finish=1;
        }
?>
    <div class="content-w">
        	                                    ...
        	                                    ?>   
                                                    <tr>
                                                        ...
                                                        <td class="text-left cell-with-media ">
                                                            <a href="<?php echo base_url().'parents/viewFile/'.$row['file_name']; ?>" class="grey">
                                                        ...
                                                        <td class="text-center bolder">
                                                            <a href="<?php echo base_url().'parents/viewFile/'.$row['file_name']; ?>" class="grey"> <span><i class="picons-thin-icon-thin-0121_download_file"></i></span> </a>
                                                        </td>
                                                    </tr>
                                                    <?php endforeach;?>
                                                </tbody>
