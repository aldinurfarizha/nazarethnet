                                            ...
                                            <table class="table table-padded">
        	                                    ...
        	                                    ?>
                                                    <tr>
                                                        ...
                                                        <td class="bolder">
                                                            <a class="grey" href="<?php echo base_url();?>parents/homeworkroom/<?php echo $row['homework_code']; ?>/<?php echo $ex[3];?>/" data-toggle="tooltip" data-placement="top" data-original-title="<?php echo getEduAppGTLang('view');?>"><i class="picons-thin-icon-thin-0043_eye_visibility_show_visible"></i></a>
                                                        </td>
                                                    </tr>
                                                <?php endforeach;?>
                                                </tbody>
