    ...
    ?>
        <div class="dl1">
                        ...
                        <table class="dl3">
                            <tr>
                                ...
                                <td class="dl7">
                                    ...
                                    <p class="dl9"><?php echo $branch->name; ?></p>
                                </td>
                            </tr>
                        </table>
                    </td>
            ...
            <table cellpadding="0" cellspacing="0" class="dl2">
                <tr>
                    ...
                    <td class="dl12">
                        ...
                        <?php if ($row['sex'] == 'M') echo getEduAppGTLang('male');
                        else echo getEduAppGTLang('female'); ?>
                    </td>
                </tr>
                <tr>
                ...
                <tr>
                    ...
                    <td class="dl12">
                        <b class="dl11"><?php echo getEduAppGTLang('branch'); ?></b><br>
                        <?= $branch->name; ?>
                    </td>
                    <td class="dl12">
                        <b class="dl11"><?php echo getEduAppGTLang('shifts'); ?></b><br>
                        <?= $shifts->name; ?>
                    </td>
                </tr>
            </table>
            <table cellpadding="0" cellspacing="0" class="dl14">
                <tr>
                    <th class="dl13" colspan="3"><?php echo getEduAppGTLang('assigned_class_section'); ?></th>
                </tr>
                <tr>
                    <th class="dl13">#</th>
                    <th class="dl13"><?php echo getEduAppGTLang('class'); ?></th>
                    <th class="dl13"><?php echo getEduAppGTLang('section'); ?></th>
                    <th class="dl13"><?php echo getEduAppGTLang('roll'); ?></th>
                </tr>
                <?php
                ...
                ?>
                    <tr>
                        ...
                        <td class="dl15">
                            <?php echo $cs->class_name; ?>
                        </td>
                        <td class="dl15">
                            <?php echo $cs->section_name; ?>
                        </td>
                        <td class="dl15">
                            <?php echo $cs->roll; ?>
                        </td>
