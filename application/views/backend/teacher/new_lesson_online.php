<div class="modal-body">
    ...
    <div class="row">
        <div class="col-md-12">
        <?php echo form_open(base_url() . 'teacher/lessons/create_lesson/'.$param2.'/', array('method' => 'post', 'enctype' => 'multipart/form-data'));?>
                ...
                <div class="form-group">
                    <label class="control-label"><?php echo getEduAppGTLang('Video_URL');?></label>
                        ...
                        <div class="form-group" style="margin-bottom:-15px;">
                            <input type="text" name="url_youtube" id="url2" class="form-control" placeholder="YouTube URL" onchange="set_video2()">
                        </div><br>
