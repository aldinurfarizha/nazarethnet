                                ...
                                <div class="ui-block">
                                    <article class="hentry post thumb-full-width">                
                                                        ...
                                                        <tbody>
                                                            <tr>
                                                                <td class="text-left cell-with-media" >
                                                                    <a href="<?php echo base_url() . 'teacher/viewFile/' . $row['file_name']; ?>"><img src="<?php echo base_url();?>public/uploads/icons/file.svg" class="height25"><span><?php echo $row['file_name'];?></span><span class="smaller">(<?php echo $row['filesize'];?>)</span></a>
                                                                </td>             
                                                            </tr>
                                                        </tbody>
                                                    </table>
                                        ...
                                        <div class="control-block-button post-control-button">
                                            <a href="#" class="btn btn-control featured-post grbg22" data-toggle="tooltip" data-placement="top" data-original-title="<?php echo getEduAppGTLang('homework');?>">
