                                ...
                                <div class="friend-item-content">
                                    ...
                                    <div class="friend-avatar">
                                        <div class="author-thumb">
                                            <img src="<?php echo base_url();?>public/uploads/<?php echo $this->db->get_where('settings', array('type' => 'logo'))->row()->description;?>" width="120px" class="bg-white no-border padd15">
                                        </div>
