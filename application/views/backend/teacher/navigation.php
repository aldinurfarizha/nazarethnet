        ...
        <div class="fixed-sidebar-left sidebar--small" id="sidebar-left">
            ...
            <div class="mCustomScrollbar" data-mcs-theme="dark">
                <ul class="left-menu">
                    ...
                    <a href="<?php echo base_url();?>teacher/online_courses/" data-toggle="tooltip" data-placement="right" data-original-title="<?php echo getEduAppGTLang('online_courses');?>">
                      <div class="left-menu-icon">
                        <i class="picons-thin-icon-thin-0593_video_play_youtube"></i>
                      </div>
                    </a>
                  </li>  
                  <li>
                        <a href="<?php echo base_url();?>teacher/team_conferences/" data-toggle="tooltip" data-placement="right" data-original-title="<?php echo getEduAppGTLang('team_conferences');?>">
                          <div class="left-menu-icon">
                            <i class="picons-thin-icon-thin-0719_group_users_circle"></i>
                          </div>
                        </a>
                      </li>
        ...
        <div class="fixed-sidebar-left sidebar--large" id="sidebar-left-1">
            ...
            <div class="mCustomScrollbar" data-mcs-theme="dark">
                <ul class="left-menu">
                    ...
                    <li>
                      <a href="<?php echo base_url();?>teacher/online_courses/">
                              <div class="left-menu-icon">
                                  <i class="picons-thin-icon-thin-0593_video_play_youtube"></i>
                              </div>
                          <span class="left-menu-title"><?php echo getEduAppGTLang('online_courses');?></span>
                          </a>
                      </li>
                      <li>
                        <a href="<?php echo base_url();?>teacher/team_conferences/">
                          <div class="left-menu-icon">
                            <i class="picons-thin-icon-thin-0719_group_users_circle"></i>
                          </div>
                          <span class="left-menu-title"><?php echo getEduAppGTLang('team_conferences');?></span>
                        </a>
                      </li>
                    <li>
