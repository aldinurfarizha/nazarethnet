<?php 
    $teacher = $this->db->get_where('news' , array('news_code' => $param2))->result_array();
...
?>
    <div class="modal-body">
        ...
        <div class="ui-block-content">
            <?php echo form_open(base_url() . 'teacher/news/update_panel/'.$row['news_code'], array('enctype' => 'multipart/form-data')); ?>
                <div class="row">
