                                ...
                                <div class="element-wrapper">
                                    <div class="element-box-tp">
                                        <h6 class="element-header">
                                            ...
                                            <div class="element-content"><a href="<?php echo base_url();?>teacher/create_homework/<?php echo $data;?>" class="text-white btn btn-control btn-grey-lighter btn-success"><i class="picons-thin-icon-thin-0001_compose_write_pencil_new"></i><div class="ripple-container"></div></a></div>
                                        </h6>
                                            ...
                                            <table class="table table-padded">
                                	            ...
                                	            ?>
                                                    <tr>
                                                        ...
                                                        <td class="bolder">
                                                            <a class="grey" href="<?php echo base_url();?>teacher/homeworkroom/<?php echo $hm['homework_code'];?>" data-toggle="tooltip" data-placement="top" data-original-title="<?php echo getEduAppGTLang('view_homework');?>"><i class="picons-thin-icon-thin-0043_eye_visibility_show_visible"></i></a>
                        						            <a data-toggle="tooltip" data-placement="top" data-original-title="<?php echo getEduAppGTLang('delete');?>" class="danger grey" href="<?php echo base_url(); ?>teacher/homework/delete/<?php echo $hm['homework_code']; ?>/<?php echo $data;?>/" onClick="return confirm('<?php echo getEduAppGTLang('confirm_delete');?>')"><i class="picons-thin-icon-thin-0056_bin_trash_recycle_delete_garbage_empty"></i></a>
                                                        </td>
                                                    </tr>
                                                    <?php endforeach;?>
                                                </tbody>
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <div class="ui-block-title mdl-header">
                        <h6 class="title text-white"><?php echo getEduAppGTLang('new_homework');?></h6>
                    </div>
