                                            ...
                                            <table style="width: 100%;">
                                                <tbody>
                                                    ...
                                                    <tr style="width: 100%; padding: 5px 0px;background-color: #E6F2F5;">
                                                        <td style="text-align: left; padding:7px 10px;">
                                                            <div class="form-group">
                                                                <a href="<?php echo base_url();?>teacher/quiz_contest/<?php echo $online_course_id;?>/<?php echo $qq['quiz_id'];?>/<?php echo $lesson_online_id;?>" id="1" style="font-size: 14px;font-weight: 400;">
