...
<head>
	...
	<script>
		var baseUR = '<?php echo base_url();?>teacher/';
...
<body>
	...
	<div class="toolbar">
		<div class="tool">
			<a href="<?php echo base_url();?>teacher/homework_details/<?php echo $homework_code;?>/" class="text-white" style="background:#95c238!important; border-radius:5px;padding:5px;text-decoration:none;"><i class="picons-thin-icon-thin-0131_arrow_back_undo"></i> <?php echo getEduAppGTLang('return');?>
			</a>
		</div>
		<div class="tool">
