    ...
    <body>
        ...
        <nav id="nav-tool" class="navbar navbar-inverse navbar-fixed-top">
            <div class="container">
                <div class="navbar-header">
                    <h4><i class="fab fa-chromecast"></i> Live Class : <?php echo $row['title']?></h4>
                </div>
                <div class="navbar-form navbar-right">
                    <h5><i class="far fa-user-circle" style=""></i> You : <?php echo $this->crud->get_name('teacher', $this->session->userdata('login_user_id'));?></h5>
                </div>
            </div>
        </nav>
        ...
        <script type="text/javascript">
            ...
            var meetConfig = {
                ...
                leaveUrl: "<?php echo base_url();?>admin/meet/<?php echo base64_encode($row['class_id']."-". $row['section_id']."-". $row['subject_id']);?>",
