                                    ...
                                    <div class="panel-body">
                                        <div class="overflow-x-auto">
                                            <table  class="table table-bordered">
                                                <thead>
                                                    <tr>
                                                        <th class="text-center" width="5%"><div>#</div></th>
                                                        <th class="text-center"><div><?php echo getEduAppGTLang('type');?></div></th>
                                                        <th class="text-center" width="60%"><div><?php echo getEduAppGTLang('question');?></div></th>
                                                        <th class="text-center" width="10%"><div><?php echo getEduAppGTLang('mark');?></div></th>
                                                        <th class="text-center"><div><?php echo getEduAppGTLang('options');?></div></th>
                                                    </tr>
                                                </thead>
                                                <tbody>
                                                <?php if (sizeof($added_question_info) == 0):?>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <?php endif; ?>
                                                        <td class="text-center"><?php echo $added_question['mark']; ?></td>
                                                        <td class="text-center">
                                                            ...
                                                            <a href="<?php echo base_url();?>teacher/delete_question_from_online_exam/<?php echo $added_question['question_bank_id'];?>" onclick="return confirm('<?php echo getEduAppGTLang('confirm_delete');?>')" class="btn btn-danger btn-sm" data-toggle="tooltip" title="<?php echo getEduAppGTLang('delete'); ?>"><i class="picons-thin-icon-thin-0057_bin_trash_recycle_delete_garbage_full" aria-hidden="true"></i></a>
                                                        </td>
                                                    </tr>
                                                    <?php endforeach; ?>
                                                <?php endif; ?>
                                ...
                                <div class="pipeline white lined-primary">
                                    ...
                                    <div class="panel-body">   
                                        <?php if($online_exam_details['post_file']){?>
                                            <a href="<?php echo base_url(); ?>public/exam/<?php echo $online_exam_details['post_file'];?>" class="btn btn-rounded btn-sm btn-primary text-white mb-3" target="_blank"><?php echo getEduAppGTLang('download_exiting_attachment');?></a>
                                            <br>
                                            <?php }else{
