                  ...
                  <div class="tab-content">
                    ...
                    <div class="edu-wall-content ng-scope" id="new_post">
                      <div class="tab-pane active show">
                        <?php echo form_open(base_url() . 'teacher/news/create/' . $data . '/', array('enctype' => 'multipart/form-data')); ?>
                        <div class="author-thumb" style="padding-right:15px;">

                          <a href="javascript:void(0)" onclick="showAjaxModal('<?php echo base_url(); ?>modal/popup/modal_photo/complete/<?php echo base64_encode($this->crud->get_image_url('teacher', $this->session->userdata('login_user_id'))); ?>');">
                            <img src="<?php echo $this->crud->get_image_url('teacher', $this->session->userdata('login_user_id')); ?>" style="width:45px;">
                          </a>
                        </div>
                        <div class="form-group with-icon label-floating is-empty" style="padding-left:10px;">
                          <textarea onkeyup="textAreaAdjust(this)" style="overflow:hidden" class="form-control" placeholder="<?php echo getEduAppGTLang('hi'); ?> <?php echo $this->db->get_where('teacher', array('teacher_id' => $this->session->userdata('login_user_id')))->row()->first_name; ?> <?php echo getEduAppGTLang('what_publish'); ?>" name="description" required=""></textarea>
                    ...
                    <div class="edu-wall-content ng-scope" id="new_video" style="display: none;">
                      <div class="tab-pane show">
                        <?php echo form_open(base_url() . 'teacher/news/create_video/' . $data . '/', array('enctype' => 'multipart/form-data')); ?>
                    ...
                    <div class="edu-wall-content ng-scope" id="new_vimeo" style="display: none;">
                      <div class="tab-pane show">
                        <?php echo form_open(base_url() . 'teacher/news/create_vimeo/' . $data . '/', array('enctype' => 'multipart/form-data')); ?>
                    ...
                    <div class="edu-wall-content ng-scope" id="new_poll" style="display: none;">
                      <?php echo form_open(base_url() . 'teacher/polls/create/' . $data . '/', array('enctype' => 'multipart/form-data')); ?>
              ...
              <div id="newsfeed-items-grid">
                ...
                ?>
                          ...
                          <div class="post__author author vcard inline-items">
                            ...
                            <div class="more">
                              ...
                              <ul class="more-dropdown">
                                ...
                                <li><a onClick="return confirm('<?php echo getEduAppGTLang('confirm_delete'); ?>')" href="<?php echo base_url(); ?>teacher/news/delete/<?php echo $news_code; ?>/<?php echo $data; ?>"><?php echo getEduAppGTLang('delete'); ?></a></li>
                              </ul>
                            </div>
                          </div>
                          <hr>
                    ...
                    <?php if ($wall['wall_type'] == 'polls') : ?>
                      ...
                      <?php
                      $usrdb = $this->db->get_where('polls', array('id' => $wall['homework_id']))->row()->user;
                      $poll_code = $this->db->get_where('polls', array('id' => $wall['homework_id']))->row()->poll_code;
                      $admin_id = $this->db->get_where('polls', array('id' => $wall['homework_id']))->row()->admin_id;
                      $options = $this->db->get_where('polls', array('id' => $wall['homework_id']))->row()->options;
                      $user = $this->db->get_where('polls', array('id' => $wall['homework_id']))->row()->uss;
                      ?>
                        ...
                        <?php if ($query->num_rows() <= 0) : ?>
                          <div class="ui-block paddingtel">
                            ...
                            <article class="hentry post">
                              <div class="post__author author vcard inline-items">
                                <a href="javascript:void(0)" onclick="showAjaxModal('<?php echo base_url(); ?>modal/popup/modal_photo/complete/<?php echo base64_encode($this->crud->get_image_url($user, $admin_id)); ?>');">
                                  <img src="<?php echo $this->crud->get_image_url($user, $admin_id); ?>" alt="author">
                                </a>
                                ...
                                <div class="more">
                                  <i class="icon-options"></i>
                                  <ul class="more-dropdown">
                                    <li><a href="<?php echo base_url(); ?>teacher/view_poll/<?php echo $poll_code; ?>/"><?php echo getEduAppGTLang('go_to_details'); ?></a></li>
                                    <li><a onClick="return confirm('<?php echo getEduAppGTLang('confirm_delete'); ?>')" href="<?php echo base_url(); ?>teacher/polls/delete/<?php echo $poll_code; ?>/<?php echo $data; ?>"><?php echo getEduAppGTLang('delete'); ?></a></li>
                                  </ul>
                                </div>
                              </div>
                              <hr>
