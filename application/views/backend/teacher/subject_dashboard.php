...
?>
                                            ...
                                            <div class="row align-items-center p-3">
                                                <div class="col-auto pr-0">
                                                    <a href="javascript:void(0)" onclick="showAjaxModal('<?php echo base_url(); ?>modal/popup/modal_photo/complete/<?php echo base64_encode($this->crud->get_image_url('teacher', $this->session->userdata('login_user_id'))); ?>');">
                                                        <img src="<?php echo $this->crud->get_image_url('teacher', $this->session->userdata('login_user_id')); ?>" alt="Profile" style="width:50px; height:50px; border-radius:50%; object-fit:cover; border: 2px solid #e5e5e5;">
                                                    </a>
                                                </div>
                                                <div class="col">
                                                    <h6 class="mb-1" style="font-weight:600; color:#333;"><?php echo $this->crud->get_name('teacher', $this->session->userdata('login_user_id')); ?></h6>
                                                ...
                                                <article class="hentry post has-post-thumbnail thumb-full-width">
                                                    ...
                                                    <div class="post__author author vcard inline-items">
                                                        ...
                                                        <div class="author-date">
                                                            <a class="h6 post__author-name fn" href="javascript:void(0);"><?= $this->crud->get_name('teacher', $admin_id); ?></a>
                                                        ...
                                                        <div class="more">
                                                            ...
                                                            <ul class="more-dropdown">
                                                                ...
                                                                <li>
                                                                    <a href="<?= base_url("admin/news/delete/$news_code/$data"); ?>" onclick="return confirm('<?= getEduAppGTLang('confirm_delete'); ?>')">
    ...
    <div class="modal fade" id="editPostModal" tabindex="-1" role="dialog" aria-labelledby="editPostModalLabel" aria-hidden="true">
        <div class="modal-dialog custom-modal-responsive" role="document">
            <div class="modal-content">
                <form action="<?= base_url('teacher/update_news/' . $data) ?>" method="post" enctype="multipart/form-data">
