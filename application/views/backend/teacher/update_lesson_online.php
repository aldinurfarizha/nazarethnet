...
<div class="modal-body">
        ...
        <div class="row">
        <div class="col-md-12">
        <?php echo form_open(base_url() . 'teacher/lessons/lesson_change/'.$param2.'/', array('method' => 'post', 'enctype' => 'multipart/form-data'));?>
            ...
            <div class="col-sm-12"  id="youtube" <?php if($less['type_video'] != 'youtube'):?> style="display: none;" <?php endif;?>>
                <div class="form-group">
                    <label class="control-label"><?php echo getEduAppGTLang('title');?>Video URL</label>
