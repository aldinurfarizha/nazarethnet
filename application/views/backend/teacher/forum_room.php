                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <td class="posts">
                                                ...
                                                <?php echo getEduAppGTLang('file');?>: <a class="btn btn-rounded btn-sm btn-primary text-white" href="<?php echo base_url();?>teacher/viewFile/<?php echo $row['file_name'];?>"><i class="os-icon       picons-thin-icon-thin-0042_attachment"></i> <?php echo $row['file_name'];?></a>
                                                <?php endif;?>
                                            </td>
                                        </tr>
                                        <?php
                            ...
                            <div class="element-box shadow lined-success">
                                <div class="row f-line">
                                    <div class="col-sm-12">
                                        ...
                                        <div class="form-group is-empty"><textarea class="form-control full-width" placeholder="<?php echo getEduAppGTLang('write_message');?>..." id="message" name="message" required="" rows="5"></textarea><span class="material-input"></span></div>
