    								...
    								<?php foreach ($students as $row) : ?>
    									<li>
    										...
    										<div class="notification-event">
    											<a href="<?php echo base_url(); ?>teacher/view_marks/<?php echo $row['student_id']; ?>/" class="h6 notification-friend"><?php echo $this->crud->get_name('student', $row['student_id']); ?></a><br>
