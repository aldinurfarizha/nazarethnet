<?php
    $question_details = $this->db->get_where('quiz_bank', array('quiz_bank_id' => $param2))->row_array();
...
?><div class="modal-body">
    ...
    <div class="row">
    <div class="col-md-12">
<?php echo form_open(base_url() . 'teacher/lessons/update_question/'.$param2 , array('method' => 'post', 'enctype' => 'multipart/form-data'));?>
        ...
        <div class="form-group">
            ...
            <div class="col-sm-12">
                <textarea name="question_title" class = "form-control" id = "question_title" rows="5" cols="80" required><?php echo $question_details['question_title']; ?></textarea>
            </div>
        </div>
