    ...
    <div class="os-tabs-w menu-shad">
      <div class="os-tabs-controls">
        <ul class="navs navs-tabs upper">
          ...
          <li class="navs-item">
            <a class="navs-links active" href="<?php echo base_url();?>teacher/gamification/<?php echo $data;?>/"><i class="os-icon picons-thin-icon-thin-0659_medal_first_place_winner_award_prize_achievement"></i><span><?php echo getEduAppGTLang('gamification');?></span></a>
          </li>
        </ul>
      </div>
    </div>
      ...
      <div class="content-box">
        ...
        <div class="edu-posts cta-with-media">
			<div style="padding:0% 0%">
				<div id='cssmenu'>
				    <ul>
				        <li class="<?php if($page == '') echo 'act';?>"><a href="<?php echo base_url();?>teacher/gamification/<?php echo $data.'/';?>"><i class="os-icon picons-thin-icon-thin-0659_medal_first_place_winner_award_prize_achievement"></i><?php echo getEduAppGTLang('resume');?></a></li>
				        <li class="<?php if($page == 'levels') echo 'act';?>"><a href="<?php echo base_url();?>teacher/gamification/<?php echo $data.'/levels';?>/"><i class="os-icon picons-thin-icon-thin-0659_medal_first_place_winner_award_prize_achievement"></i><?php echo getEduAppGTLang('levels');?></a></li>
				        <li class="<?php if($page == 'rules') echo 'act';?>"><a href="<?php echo base_url();?>teacher/gamification/<?php echo $data.'/rules';?>/"><i class="os-icon picons-thin-icon-thin-0389_gavel_hammer_law_judge_court"></i><?php echo getEduAppGTLang('rules');?></a></li>
				        <li class="<?php if($page == 'settings') echo 'act';?>"><a href="<?php echo base_url();?>teacher/gamification/<?php echo $data.'/settings';?>/"><i class="os-icon picons-thin-icon-thin-0659_medal_first_place_winner_award_prize_achievement"></i><?php echo getEduAppGTLang('settings');?></a></li>
				    </ul>
				</div>
			</div>
			<?php if($page == 'rules'):?>
              <div class="element-wrapper"> 
                <div class="element-box lined-primary shadow">
                  ...
                  <br>
                  <?php echo form_open(base_url() . 'teacher/gamification/update_rules/'.$data, array('enctype' => 'multipart/form-data')); ?>
                  <div class="row">
                   <div class="col-sm-6">
			...
			<br>
                ...
                <?php
                    ...
                    <tr style="height:25px;">                    
                        ...
                        <td>
                            <a class="btn btn-danger btn-sm" href="<?php echo base_url();?>teacher/gamification/delete/<?php echo $data;?>/<?php echo $rowx['student_id'];?>" onclick="return confirm('<?php echo getEduAppGTLang('confirm_delete');?>');">Clear EXP</a>
                        </td>
                    </tr>
                    <?php endforeach;?>
                  </tbody>
            ...
            <?php if($page == 'settings'):?>
              <div class="element-wrapper"> 
                <div class="element-box lined-primary shadow">
                  ...
                  <br>
                  <?php echo form_open(base_url() . 'teacher/gamification/update_settings/'.$data, array('enctype' => 'multipart/form-data')); ?>
                  <div class="row">
                   <div class="col-sm-6">
                       <div class="form-group label-floating is-select">
