                        ...
                        <div class="col-sm-12">
                            <div class="pipeline white lined-secondary">
                                ...
                                <?php 
                                    ...
                                    $exams = $this->db->get_where('exam', array('class_id' => $student_infos->class_id, 'section_id' => $student_infos->section_id))->result_array();
                                        ...
                                        <div class="element-box lined-primary">
                                            ...
                                            <div class="table-responsive">
                                                <table class="table table-lightborder">
                                                    ...
                                                    <tbody>
                                                    <?php 
                                                        $subjects = $this->db->get_where('subject' , array('class_id' => $student_infos->class_id, 'section_id' => $student_infos->section_id))->result_array();
                                                        foreach ($subjects as $row3): 
                                                        $obtained_mark_query = $this->db->get_where('mark' , array('subject_id' => $row3['subject_id'], 'exam_id' => $row2['exam_id'],'class_id' => $student_infos->class_id, 'student_id' => $student_id, 'year' => $running_year));
