    ...
    <?php $userDetail = $this->db->get_where('accountant', array('accountant_id' => $this->session->userdata('login_user_id')))->row();?>
            ...
            <div class="control-block">
                            ...
                            ?>
                                ...
                                <li class="message-unread">
                                    ...
                                    <div class="notification-event">
                                        ...
                                        <span class="chat-message-item justify"><?php if($rw->sender == $fancy_current_user) echo getEduAppGTLang('you').": " .substr($rw->message, 0, 90).'...'; else echo substr($rw->message, 0, 90);?>...</span>
                ...
                <div class="author-page author vcard inline-items more">
                    ...
                    <a href="javascript:void(0);" class="author-name fn">
                        ...
                        <span class="author-subtitle"><?php echo ucwords($this->session->userdata('login_type'));?> - <?php  echo getDetailBranch($userDetail->branch_id)->name; ?></span>
                    </a>
                </div>
            </div>
        </div>
                    ...
                    ?>
                        ...
                        <li class="message-unread">
                            ...
                            <div class="notification-event">
                                ...
                                <span class="chat-message-item" class="justify"><?php if($rw->sender == $fancy_current_user) echo getEduAppGTLang('you').": ". substr($rw->message, 0, 90).'...'; else echo substr($rw->message, 0, 90);?>...</span>
                                <span class="notification-date"><time class="entry-date updated"><?php echo $rw->timestamp;?></time></span>
                            </div>
                        </li>
                    <?php endforeach;?>
