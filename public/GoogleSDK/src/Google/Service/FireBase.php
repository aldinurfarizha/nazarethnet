 ...
 * @author Google, Inc.
 */
class Google_Service_Firebase extends Google_Service
{
  ...
  public function __construct(Google_Client $client)
  {
    ...
    $this->url = new Google_Service_Firebase_Url_Resource(
        $this,
        $this->serviceName,
        'url',
        array(
 ...
 * Typical usage is:
 *  <code>
 *   $firebaseService = new Google_Service_Firebase(...);
 *   $url = $firebaseService->url;
 *  </code>
 */
class Google_Service_Firebase_Url_Resource extends Google_Service_Resource
{
...
class Google_Service_Firebase_Url extends Google_Model
{
