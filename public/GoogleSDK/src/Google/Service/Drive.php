...
class Google_Service_Drive extends Google_Service
{
    ...
    public function __construct(Google_Client $client)
    {
        ...
        $this->drives = new Google_Service_Drive_Drives_Resource(
            $this,
            $this->serviceName,
            'drives',
            [
...
class Google_Service_Drive_Files_Resource extends Google_Service_Resource
{
     ...
     *
     * @return Google_Http_Request|Google_Service_Drive_DriveFile
     */
     ...
     *
     * @return Google_Http_Request|Google_Service_Drive_FileList
     */
...
class Google_Service_Drive_Drives_Resource extends Google_Service_Resource
{
    /**
     ...
     */
    public function create(Google_Service_Drive_Drive $postBody, $optParams = [])
    {
        $params = ['postBody' => $postBody];
        $params = array_merge($params, $optParams);

        return $this->call('create', [$params], 'Google_Service_Drive_Drive');
    }
    ...
    public function get($fileId, $optParams = [])
    {
        ...
        return $this->call('get', [$params], 'Google_Service_Drive_DriveList');
    }
    ...
    public function listDrives($optParams = [])
    {
        ...
        return $this->call('list', [$params], 'Google_Service_Drive_DriveList');
    }
     ...
     * @return Google_Service_Drive_DriveList
     */
    public function update($fileId, Google_Service_Drive_Drive $postBody, $optParams = [])
    {
        $params = ['driveId' => $fileId, 'postBody' => $postBody];
        $params = array_merge($params, $optParams);

        return $this->call('update', [$params], 'Google_Service_Drive_DriveList');
    }
}
