...
class Google_IO_Curl extends Google_IO_Abstract
{
   ...
   */
    public function executeRequest(Google_Http_Request $request)
    {
        ...
        /*if (defined('FORCE_CURL_HTTP_VERSION_1_1') && FORCE_CURL_HTTP_VERSION_1_1 === true){
            // Prevent 'Uncaught Google_IO_Exception: HTTP/2 stream 0 was not closed cleanly: PROTOCOL_ERROR (err 1)' errors
  ...
  public function setDefaultOptions()
  {
    ...
    $timeout = $this->client->getClassConfig('Google_IO_Abstract', 'request_timeout_seconds');
    if ($timeout > 0) {
