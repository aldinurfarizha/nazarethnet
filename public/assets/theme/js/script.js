...
redips.init = function () {
	...
	rd.event.dropped = function () {
		...
		if (rd.td.target !== rd.td.source) { 
			redips.printMessage('El contenido ha cambiado, no te olvides de guardar los cambios.');
		}
...
redips.save = function () 
{
	...
	// and save content
	window.location.href = redipsURL+'admin/schedules/save?' + content+'&class_id='+class_id+'&section_id='+section_id;
};
