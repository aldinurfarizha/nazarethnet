...
-- Tiempo de generación: 04-12-2023 a las 10:07:14
...
--
-- Base de datos: `mayansourcecom_edu`
--
...
CREATE TABLE `accountant` (
  ...
  `fb_token` longtext CHARACTER SET utf8 COLLATE utf8_unicode_ci DEFAULT NULL,
  `fb_id` longtext CHARACTER SET utf8 COLLATE utf8_unicode_ci DEFAULT NULL,
  `fb_photo` longtext CHARACTER SET utf8 COLLATE utf8_unicode_ci DEFAULT NULL,
  `fb_name` longtext CHARACTER SET utf8 COLLATE utf8_unicode_ci DEFAULT NULL,
  `g_oauth` longtext CHARACTER SET utf8 COLLATE utf8_unicode_ci DEFAULT NULL,
  `g_fname` longtext CHARACTER SET utf8 COLLATE utf8_unicode_ci DEFAULT NULL,
  `femail` longtext CHARACTER SET utf8 COLLATE utf8_unicode_ci DEFAULT NULL,
  `g_lname` longtext CHARACTER SET utf8 COLLATE utf8_unicode_ci DEFAULT NULL,
  `g_picture` longtext CHARACTER SET utf8 COLLATE utf8_unicode_ci DEFAULT NULL,
  `link` longtext CHARACTER SET utf8 COLLATE utf8_unicode_ci DEFAULT NULL,
  `g_email` longtext CHARACTER SET utf8 COLLATE utf8_unicode_ci DEFAULT NULL,
...
CREATE TABLE `admin` (
  ...
  `authentication_key` varchar(600) DEFAULT NULL,
  `fb_token` varchar(500) DEFAULT NULL,
  `fb_id` varchar(500) DEFAULT NULL,
  `fb_photo` varchar(500) DEFAULT NULL,
  `fb_name` varchar(500) DEFAULT NULL,
  `g_oauth` varchar(500) DEFAULT NULL,
  `g_fname` varchar(500) DEFAULT NULL,
  `femail` varchar(500) DEFAULT NULL,
  `g_lname` varchar(500) DEFAULT NULL,
  `g_picture` varchar(500) DEFAULT NULL,
  `link` varchar(500) DEFAULT NULL,
  `g_email` varchar(500) DEFAULT NULL,
  `gender` varchar(200) DEFAULT NULL,
  `image` longtext DEFAULT NULL,
  `idcard` varchar(200) DEFAULT NULL,
  `profession` varchar(200) DEFAULT NULL,
  `since` varchar(200) DEFAULT NULL
...
CREATE TABLE `book_request` (
  ...
  `student_id` int(11) DEFAULT NULL,
  `issue_start_date` longtext DEFAULT NULL,
  `issue_end_date` longtext DEFAULT NULL,
...
CREATE TABLE `class_routine` (
  ...
  `section_id` int(11) DEFAULT NULL,
  `subject_id` int(11) DEFAULT NULL,
  `time_start` varchar(200) DEFAULT NULL,
  `time_end` varchar(11) DEFAULT NULL,
  `time_start_min` varchar(11) DEFAULT NULL,
  `time_end_min` varchar(11) DEFAULT NULL,
...
CREATE TABLE `enroll` (
  ...
  `enroll_code` longtext NOT NULL,
  `student_id` int(11) NOT NULL,
  `class_id` int(11) NOT NULL,
  `section_id` int(11) DEFAULT NULL,
  `roll` varchar(500) NOT NULL DEFAULT '0',
...
(1, 'home_title', 'Get the best education with EduAppGT PRO'),
(2, 'home_subtitle', 'Connect with teachers who are 100% trained and available to help your education.'),
(3, 'home_text_button_1', 'Try it for free'),
(4, 'home_redirect_button_1', 'https://guateapps.app'),
(5, 'home_text_button_2', 'How it works?'),
(6, 'home_redirect_button_2', 'https://guateapps.app'),
(7, 'home_image', 'bdb55430f1e4a850f2e6fef84162c161bg_home.png'),
(8, 'why_us_title', 'Why choose us?'),
(9, 'why_us_subtitle', 'Know all the benefits you will have when using EduAppGT PRO'),
(10, 'why_us_card_1_title', 'Tutor availability'),
(11, 'why_us_card_1_description', 'Lorem Ipsum is simply dummy text of the printing and typesetting industry. '),
(12, 'why_us_card_2_title', '24/7 Tutor Availability'),
(13, 'why_us_card_2_description', 'Lorem Ipsum is simply dummy text of the printing and typesetting industry. '),
(14, 'why_us_card_3_title', 'Interactive Whiteboard'),
(15, 'why_us_card_3_description', 'Lorem Ipsum is simply dummy text of the printing and typesetting industry. '),
(16, 'why_us_bottom_title', 'All tools in one platform'),
(17, 'why_us_bottom_subtitle', 'Connect, chat and learn with EduAppGT PRO - School Management System.'),
(18, 'principal_intro', 'Customize with your schedule'),
(19, 'principal_title', 'Personalized Professional Online Tuor on Your Schedule.'),
(20, 'principal_description', 'Our scheduling system allows for careful decision-making in terms of time and student suitability, with aour tutors available in a variety of time slots entirely designed around each student\'s individual pace.'),
(21, 'principal_text_button', 'Get Started'),
(22, 'principal_redirect_button', 'https://guateapps.app'),
(23, 'principal_image', 'f75b000a5d0c2c8527ff20a37557d3aastudents.png'),
(24, 'second_intro', 'About us'),
(25, 'second_title', 'Talented and Highly Qualified Tutors to Serve you for Online Help.'),
(26, 'second_description', 'EduAppGT is the best online tutoring platform in the world. Founded in 2010 and located in Tangerang, Indonesia. EduAppGT provides quality experiences and support for students.'),
(27, 'second_text_button', 'How it works?'),
(28, 'second_redirect_button', 'https://guateapps.app'),
(29, 'second_image', '4a204d903e48828c21ae2e8c7abf3227last.png'),
(30, 'about_title', 'About Us'),
(31, 'about_subtitle', 'EduAppGT PRO School Management System is a powerfull tool for all schools.'),
(32, 'about_text_button', 'Get Started'),
(33, 'about_redirect_button', 'https://guateapps.app'),
(34, 'about_image', '94a7cdb8fd2c0ab7cce615336b73a9c4last.png'),
(35, 'widget_title', 'Why us?'),
(36, 'widget_subtitle', 'Why us description'),
(37, 'about_mission', 'Our Mission'),
(38, 'about_mission_description', 'All Of Our Special Education Experts Have A Degree In Special Education.'),
(39, 'about_vission', 'Our Vission'),
(40, 'about_vission_description', 'Our digital whiteboard wquipped with audio-video-chat features.'),
(41, 'about_bottom_title', 'All tools in one platform'),
(42, 'about_bottom_subtitle', 'Connect, chat and learn with EduAppGT PRO - School Management System.'),
(43, 'about_intro_text', 'Customize with your schedule'),
(44, 'about_title_1', 'Personalized Professional Online Tuor on Your Schedule.'),
(45, 'about_description_1', 'Our scheduling system allows for careful decision-making in terms of time and student suitability, with aour tutors available in a variety of time slots entirely designed around each student\'s individual pace.'),
(46, 'about_text_button', 'Get Started'),
(47, 'about_redirect_button', 'https://guateapps.app'),
(48, 'about_image_widget', '0a8faf6ff78a17c9d8dd144e2baeea62students.png'),
(49, 'footer_logo', '6e6f62d07f18a2158e84dde2dd235c48logo-w.png'),
(50, 'footer_text', 'My Tutor is the best online tutoring platform in the world. Founded in 2010 and located in Tangerang.'),
(51, 'site_key', 'YOUR_SITE_KEY'),
(52, 'secret_key', 'YOUR_SECRET_KEY'),
(53, 'map_contact', 'https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d964.1330336611983!2d-91.53588257076967!3d14.851493795655797!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x858e981a1c33b2e9%3A0x64ccbc38a406481c!2sTorre%20Pradera%20Xela!5e0!3m2!1sen!2sgt!4v1657929924416!5m2!1sen!2sgt');
...
CREATE TABLE `grade` (
  ...
  `grade_point` longtext DEFAULT NULL,
...
CREATE TABLE `live` (
  ...
  `room` longtext CHARACTER SET utf8 COLLATE utf8_unicode_ci DEFAULT NULL,
  `siteUrl` longtext CHARACTER SET utf8 COLLATE utf8_unicode_ci DEFAULT NULL,
...
CREATE TABLE `mark` (
  ...
  `year` longtext NOT NULL,
  `labuno` varchar(200) DEFAULT NULL,
  `labdos` varchar(200) DEFAULT NULL,
  `labtres` varchar(200) DEFAULT NULL,
  `labcuatro` varchar(200) DEFAULT NULL,
  `labcinco` varchar(200) DEFAULT NULL,
  `labseis` varchar(200) DEFAULT NULL,
  `labsiete` varchar(200) DEFAULT NULL,
  `labocho` varchar(200) DEFAULT NULL,
  `labnueve` varchar(200) DEFAULT NULL,
  `labtotal` varchar(200) DEFAULT NULL,
...
CREATE TABLE `online_exam` (
  ...
  `duration` text DEFAULT NULL COMMENT 'duration in second',
  `minimum_percentage` text DEFAULT NULL,
  `instruction` longtext DEFAULT NULL,
  `status` varchar(255) DEFAULT 'pending',
  `running_year` varchar(255) DEFAULT '',
  `wall_type` varchar(20) DEFAULT NULL,
  `publish_date` varchar(20) DEFAULT NULL,
  `uploader_type` varchar(20) DEFAULT NULL,
...
CREATE TABLE `online_exam_result` (
  ...
  `obtained_mark` text DEFAULT NULL,
  `status` text DEFAULT NULL,
  `exam_started_timestamp` longtext DEFAULT NULL,
...
CREATE TABLE `question_bank` (
  ...
  `online_exam_id` int(11) DEFAULT NULL,
  `question_title` longtext DEFAULT NULL,
...
CREATE TABLE `question_paper` (
  ...
  `title` longtext DEFAULT NULL,
  `question_paper` longtext DEFAULT NULL,
  `class_id` int(11) DEFAULT NULL,
...
CREATE TABLE `student` (
  ...
  `authorized_phone` varchar(200) DEFAULT NULL,
...
CREATE TABLE `subject` (
  ...
  `teacher_id` int(11) DEFAULT NULL,
  `year` longtext NOT NULL,
  `la1` varchar(500) DEFAULT 'Lab 1.',
  `la2` varchar(500) DEFAULT 'Lab 2.',
  `la3` varchar(500) DEFAULT 'Lab 3.',
  `la4` varchar(500) DEFAULT 'Lab 4.',
  `la5` varchar(500) DEFAULT 'Lab 5.',
  `la6` varchar(500) DEFAULT 'Lab 6.',
  `la7` varchar(500) DEFAULT 'Lab 7.',
  `la8` varchar(500) DEFAULT 'Lab 8.',
  `la9` varchar(500) DEFAULT 'Lab 9.',
  `la10` varchar(500) DEFAULT 'Lab 10.',
  `type` varchar(200) DEFAULT NULL,
  `section_id` int(11) NOT NULL,
...
CREATE TABLE `teacher` (
  ...
  `user_code` longtext DEFAULT NULL,
  `fb_token` varchar(500) DEFAULT NULL,
  `fb_id` varchar(500) DEFAULT NULL,
  `fb_photo` varchar(500) DEFAULT NULL,
  `fb_name` varchar(500) DEFAULT NULL,
...
CREATE TABLE `ticket` (
  ...
  `title` longtext NOT NULL,
  `ticket_code` longtext NOT NULL,
  `status` longtext NOT NULL COMMENT 'opened closed',
  `priority` longtext NOT NULL COMMENT 'baja media alta',
  `description` longtext NOT NULL,
  `student_id` int(11) NOT NULL,
...
--
-- Indices de la tabla `activity_read`
--
...
--
-- Indices de la tabla `attendance_live`
--
...
--
-- Indices de la tabla `book_request`
--
...
--
-- Indices de la tabla `homework_files`
--
...
--
-- Indices de la tabla `live`
--
ALTER TABLE `live`
  ADD PRIMARY KEY (`live_id`);

--
-- Indices de la tabla `live_status`
--
...
--
-- Indices de la tabla `online_exam_result`
--
...
--
-- Indices de la tabla `question_paper`
--
ALTER TABLE `question_paper`
  ADD PRIMARY KEY (`question_paper_id`);

--
-- Indices de la tabla `readed`
--
ALTER TABLE `readed`
...
--
ALTER TABLE `academic_settings`
  MODIFY `settings_id` int(100) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=27;
...
--
-- AUTO_INCREMENT de la tabla `activity_read`
--
ALTER TABLE `activity_read`
...
--
-- AUTO_INCREMENT de la tabla `attendance_live`
--
ALTER TABLE `attendance_live`
...
--
-- AUTO_INCREMENT de la tabla `book_request`
--
ALTER TABLE `book_request`
...
--
-- AUTO_INCREMENT de la tabla `homework_files`
--
ALTER TABLE `homework_files`
  MODIFY `fhomework_file_id` int(11) NOT NULL AUTO_INCREMENT;
...
--
ALTER TABLE `language`
  MODIFY `phrase_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=3829;
...
--
-- AUTO_INCREMENT de la tabla `live`
--
ALTER TABLE `live`
  MODIFY `live_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=2;

--
-- AUTO_INCREMENT de la tabla `live_status`
--
ALTER TABLE `live_status`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT;
...
--
-- AUTO_INCREMENT de la tabla `online_exam_result`
--
ALTER TABLE `online_exam_result`
...
--
ALTER TABLE `question_bank`
  MODIFY `question_bank_id` int(11) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=5;

--
-- AUTO_INCREMENT de la tabla `question_paper`
--
ALTER TABLE `question_paper`
  MODIFY `question_paper_id` int(11) NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT de la tabla `readed`
--
ALTER TABLE `readed`
  MODIFY `readed_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=2;
...
--
ALTER TABLE `settings`
  MODIFY `settings_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=67;
